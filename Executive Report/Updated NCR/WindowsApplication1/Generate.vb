...
Public Class Generate
    ...
    Public Sub GenerateReport()
        ...
        If UCase(vClass_01.Trim) = "NCR" Then
            reportPath = Application.StartupPath & "\Reports\NCR\" & rptName.Trim
        Else
        ...
        Try
            ...
            If checkFile(ls_attachment) = False Then
                ...
                If report_paramClass_01 <> "" Then
                    rptDocument.SetParameterValue(report_paramClass_01, IIf(report_valueClass_01 = "NCR", "Luzon/NCR", report_valueClass_01))
                End If
