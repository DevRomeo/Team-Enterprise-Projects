...
Public Class PartnersReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KPPartnersComparativeReport.PartnersReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_prevMonth() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPartnersReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PartnersReport = New PartnersReport
        rpt.Site = Me.Site
        Return rpt
    End Function
