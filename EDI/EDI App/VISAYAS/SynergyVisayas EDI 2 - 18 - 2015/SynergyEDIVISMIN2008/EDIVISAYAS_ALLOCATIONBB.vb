...
extloop:
        ...
        Dim act As String = "EDI" & " " & "BaseAllocation" & " " & "for" & " " & txtDesc.Text
        Call CheckBC_Errors()
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(New EDIService.Service().alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "baseallocation_corp", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
