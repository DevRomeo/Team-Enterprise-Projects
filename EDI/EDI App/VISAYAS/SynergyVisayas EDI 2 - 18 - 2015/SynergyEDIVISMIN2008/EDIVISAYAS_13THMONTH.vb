...
Public Class EDIVISAYAS_13THMONTH
    ...
    Dim folder1 As String = "C:\SynergVisayas\"
    ...
    Private Sub EDIVISMIN_13THMONTH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "13th Month-" + ediname + " " & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "13th Month")
            Exit Sub
        End If
...
extloop:
        ...
        response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "thirmonth_corp", edi), GetType(Response))
        If response.responseCode = ResponseCode.Error Then
            MessageBox.Show(response.responseMessage)
...
alreadysaveext:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(New EDIService.Service().alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "thirmonth_corp", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
