...
Public Class EDIVISAYAS_GLOBESMART
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If cmbGS.Text = "" Then
            MsgBox("Fill first phone Company", 16, "Synergy EDI-" + ediname)
            Exit Sub
        End If
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Synergy EDI-" + ediname)
            Exit Sub
        End If
...
extloop:
        ...
        response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "Globesmartbill_corp", edi), GetType(Response))
        If response.responseCode = ResponseCode.Error Then
            MessageBox.Show(response.responseMessage)
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To GRD.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(New EDIService.Service().alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "Globesmartbill_corp", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
...
extcase:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5330003, Credit - 3100005", 64, "Synergy EDI-" + ediname)
        Exit Sub
    End Sub
