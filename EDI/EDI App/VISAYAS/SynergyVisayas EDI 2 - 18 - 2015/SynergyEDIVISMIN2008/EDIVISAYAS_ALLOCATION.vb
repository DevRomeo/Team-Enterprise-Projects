...
Public Class EDIVISAYAS_ALLOCATION
    ...
    Private Sub EDIVISMIN_ALLOCATION_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Allocation-" + ediname + " " & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Allocation-" + ediname)
            Exit Sub
        End If
        ...
        For n = Val(txtStart.Text) - 2 To 0 Step -1
            ...
            If Not Trim(dg.Item(n, 0).ToString) = "" Then
                ...
                Else
                    ...
                    If rdr.Read Then
                        MsgBox("Some datas have not included. Please Check Excel File", 64, "Synergy EDI-" + ediname)
...
extloop:
        ...
        response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "allocation_corp", edi), GetType(Response))
        If response.responseCode = ResponseCode.Error Then
            MessageBox.Show(response.responseMessage)
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(New EDIService.Service().alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "allocation_corp", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
