...
Public Class EDIVISAYAS_GlobeBillBB
    ...
    Private Sub EDIVISMIN_GlobeBillBaseBranch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Globe Bill-" + ediname + " " & gs_serverloc2 & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Globe-" + edi)
            Exit Sub
        End If
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(New EDIService.Service().alreadySaved(g, cboPeriod.Text, cboYear.Text, "GLOBE", "smart3_corp", "companydesc", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
