...
extloop:
        ...
        Dim act As String = "EDI" & " " & "13thMonth BB" & " " & "for" & " " & txtDesc.Text
        Call CheckBC_Errors()
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(New EDIService.Service().alreadySaved(g, cboPeriod.Text, cboYear.Text, "13thMonth BB", "basethirmonth_corp", "paydesc", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
...
ext:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "13thBB"
    End Sub
End Class
