...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(New EDIService.Service().alreadySaved(g, cboPeriod.Text, cboYear.Text, "EDI Report", "EDIREPORT_corp", "descs", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
