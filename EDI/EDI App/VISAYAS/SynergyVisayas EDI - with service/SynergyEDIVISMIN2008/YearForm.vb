    ...
    Private Sub txtyear_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtyear.KeyPress
        ...
        If e.KeyChar = Chr(13) Then
            If callnull() = True Then
                MsgBox("Input correct year first before you proceed", 64, "EDI - Visayas")
                Exit Sub
            Else
                callyear = txtyear.Text
                If callyear > yearnow Then
                    MsgBox("Year inputted is greater than existing year", 64, "EDI - Visayas")
                    Exit Sub
                ElseIf callyear <= 2006 Then
                    MsgBox("Year inputted is lesser than accepted year reference", 64, "EDI - Visayas")
                    Exit Sub
                Else
                    Me.Hide()
                    CALLEDIFUNC()
