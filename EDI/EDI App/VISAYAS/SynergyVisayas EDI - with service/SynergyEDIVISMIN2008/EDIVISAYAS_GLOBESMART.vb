...
Public Class EDIVISAYAS_GLOBESMART
    ...
    Private Sub EDIVISMIN_GLOBESMART_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_GLOBESMART_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Globe/Smart-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        'Dim test As New EDIService.Service
        'MessageBox.Show(test.getBranch("017", "EDIVISAYAS"))
        'Dim response As New EDIdataClass.Response

        'Dim AM As response = DirectCast(JsonConvert.DeserializeObject(test.getBranch("017", "EDIVISAYAS"), GetType(Response)), Response)
        'Dim respdata As New EDIdataClass.Branch
        'respdata = DirectCast(JsonConvert.DeserializeObject(AM.responseData, GetType(EDIdataClass.Response)), EDIdataClass.Branch)
        'MessageBox.Show(AM.responseCode)
        'Return

        If cmbGS.Text = "" Then
            MsgBox("Fill first phone Company", 16, "Synergy EDI Visayas")
            Exit Sub
        End If
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Synergy EDI Visayas")
            Exit Sub
        End If
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtDesc.Text = "" Or cmbGS.Text = "" Then
        ...
        Dim descr As String = cmbGS.Text & " " & " Bill" & " " & Label7.Text
...
continuesave:
        ...
        sqltxt = "select * from globesmartbill_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into globesmartbill_corp(bcode,companydesc,month_eli, year_eli, " & _
                         "date_time, sys_creator) values('" & Trim(rBC) & _
                         "','" + cmbGS.SelectedItem + "','" & Format(g_month, "MM").ToString & "', '" & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Globe/Smart" & " " & "for" & " " & cmbGS.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To GRD.Rows - 2
            ...
            Dim s As String = "Select * from globesmartbill_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' and companydesc = '" + cmbGS.Text + "'"
...
extcase:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5330003, Credit - 3100005", 64, "Synergy EDI Visayas")
        Exit Sub
    End Sub
