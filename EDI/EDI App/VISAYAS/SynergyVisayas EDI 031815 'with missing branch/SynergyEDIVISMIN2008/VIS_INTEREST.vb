...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Interest" & " " & "for" & " " & txtDesc.Text
        Call CheckBC_Errors()
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            response = JsonConvert.DeserializeObject(service.alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "NCLINTEREST_corp", edi), GetType(Response))
            If response.responseCode = ResponseCode.OK Then
