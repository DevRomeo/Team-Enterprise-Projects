...
extloop:
        ...
        Try
            response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "MoneyExpress_corp", edi), GetType(Response))
        Catch ex As Exception
        ...
        Dim act As String = "EDI" & " " & "EXPRESS Money" & " " & "for" & " " & txtDesc.Text
        Call CheckBC_Errors()
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Try
                response = JsonConvert.DeserializeObject(service.alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "MoneyExpress_corp", edi), GetType(Response))
            Catch ex As Exception
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3135004, Credit - 4220052", 64, "Synergy EDI-" + ediname)
        Exit Sub
    End Sub
