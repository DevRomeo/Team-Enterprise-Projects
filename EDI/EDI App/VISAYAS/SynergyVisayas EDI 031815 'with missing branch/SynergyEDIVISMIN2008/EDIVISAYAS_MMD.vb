...
continuesave:
        ...
        For n = 0 To grd.Rows - 2
            ...
            If response.responseCode = ResponseCode.OK Then            'rdr.close - x
                ...
                If response.responseCode <> ResponseCode.NotFound Then                            'rdr.close - ok
...
extloop:
        ...
        Next
        Try
            response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "MMD_corp", edi), GetType(Response))
        Catch ex As Exception
        ...
        End If
        If (response.responseCode = ResponseCode.OK) Then
            Dim user As User = toUser(response.responseData.ToString)
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Try
                response = JsonConvert.DeserializeObject(service.alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "MMD_corp", edi), GetType(Response))
            Catch ex As Exception
                MessageBox.Show(ex.Message)
                Me.Close()
            End Try
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
       ...
       vbCrLf & "Debit - 1110007,  Debit - 1110005 , Credit - 3100005", 64, "Synergy EDI-" + ediname)
        Exit Sub
    End Sub
