...
extloop:
        ...
        Next
        Try
            response = JsonConvert.DeserializeObject(service.insertTransactionWithDesc(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "GlobeSmartBill_corp", "Companydesc", edi), GetType(Response))
        Catch ex As Exception
        ...
        Dim act As String = "EDI" & " " & "GlobeSmart" & " " & "for" & " " & txtDesc.Text
        Call CheckBC_Errors()
        Try
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To GRD.Rows - 2
            ...
            Try
                response = JsonConvert.DeserializeObject(service.alreadySaved(g, cboPeriod.Text, cboYear.Text, "Globe Smart", "Globesmartbill_corp", "companydesc", edi), GetType(Response))
            Catch ex As Exception
                MessageBox.Show(ex.Message)
                Me.Close()
            End Try
