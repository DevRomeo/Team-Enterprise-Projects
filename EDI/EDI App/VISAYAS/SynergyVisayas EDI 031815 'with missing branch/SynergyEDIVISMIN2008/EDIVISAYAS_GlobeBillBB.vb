...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Globe BaseBranch" & " " & "for" & " " & txtDesc.Text
        Call CheckBC_Errors()
        Try
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Try
                response = JsonConvert.DeserializeObject(service.alreadySaved(g, cboPeriod.Text, cboYear.Text, "GLOBE BaseBranch", "smart3_corp", "companydesc", edi), GetType(Response))
            Catch ex As Exception
                MessageBox.Show(ex.Message)
                Me.Close()
            End Try
