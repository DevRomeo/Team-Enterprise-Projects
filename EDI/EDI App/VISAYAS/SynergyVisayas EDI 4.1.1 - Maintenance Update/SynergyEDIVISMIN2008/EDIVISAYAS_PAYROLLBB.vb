...
alreadysavedRetry:
                ...
                response = JsonConvert.DeserializeObject(service.alreadySaved(g, cboPeriod.Text, cboYear.Text, paydesc, "basepayroll_corp", "paydesc", edi), GetType(Response))
            Catch ex As Exception
...
saveRetry:
            ...
            response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "basepayroll_corp", edi), GetType(Response))
        Catch ex As Exception
            If (retryCount < maxretry) Then
                retryCount += 1
                GoTo saveRetry
...
ext:
    ...
    '    Label7.Text = txtDesc.Text & " " & cmbdesc.Text & " " & "Payroll BaseBranch"
    'End Sub
