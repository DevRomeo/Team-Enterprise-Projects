...
Public Class EDIVISAYAS_SSMI
    ...
    Private Sub EDIVISMIN_SSMI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        MessageBox.Show(Main.TabControl1.SelectedIndex.ToString())
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        If (edi.Equals("EDISHOWROOM")) Then
            MsgBox("Debit - 5370003, Credit - 3100002", 64, "Synergy EDI-" + ediname)
        Else
            MsgBox("Debit - 5370003, Credit - 3100005", 64, "Synergy EDI-" + ediname)
            'Exit Sub
        End If
    End Sub
    Private Function balancedata() As Boolean
        ...
        For n = 0 To GRD.Rows - 2
            For r = 1 To nn
                ...
                Dim d As Double
                Dim c As Double
                If Me.Text.Contains("Jewellers") Then
                    If r = 4 Then
                    ...
                    End If
                ElseIf Me.Text.Contains("Per Branch") Then
                    If r = 2 Then
                        d = Trim(CDbl(Format(total_debit, "#,##0.00")))
                        c = Trim(CDbl(Format(total_credit, "#,##0.00")))
                        If r = 2 And d <> c Then
