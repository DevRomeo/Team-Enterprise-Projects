...
Public Class EDIVISAYAS_UNUSEDSICKLEAVE
...
extloop:
        ...
        Try
saveRetry:
            response = JsonConvert.DeserializeObject(service.insertTransactionWithDesc(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "BaseCorpUnusedSickLeave_corp", "paydesc", edi), GetType(Response))
        Catch ex As Exception
            If (retryCount < maxretry) Then
                retryCount += 1
                GoTo saveRetry
...
alreadysavedRetry:
                ...
                response = JsonConvert.DeserializeObject(service.alreadySaved(g, cboPeriod.Text, cboYear.Text, "UnusedSickLeave BaseBranch", "BaseCorpUnusedSickLeave_corp", "paydesc", edi), GetType(Response))
            Catch ex As Exception
                If (retryCount < maxretry) Then
                    retryCount += 1
...
ext:
    ...
    Private Sub grp_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grp.Enter
