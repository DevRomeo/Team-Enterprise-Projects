...
extloop:
        ...
        Try
saveRetry:
            response = JsonConvert.DeserializeObject(service.insertTransactionWithDesc(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "sg_corp1", "paydesc", edi), GetType(Response))
        Catch ex As Exception
            If (retryCount < maxretry) Then
                retryCount += 1
                GoTo saveRetry
...
alreadysavedRetry:
                response = JsonConvert.DeserializeObject(service.alreadySaved(g, cboPeriod.Text, cboYear.Text, "Security", "sg_corp1", "paydesc", edi), GetType(Response))
            Catch ex As Exception
                If (retryCount < maxretry) Then
                    retryCount += 1
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5370001, Debit - 2070103, Credit - 3100001", 64, "Synergy EDI-" + ediname)
        Exit Sub
    End Sub
