...
Public Class EDIVISAYAS_REMITTANCEBB
                    ...
                    Select Case r
                        ...
                        Case 62
                            ...
                            If amount <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 130)))
                                CompanyAccountCode = "3100001"
                                'descr = txtDesc.Text & " " & "IAD PHIL ER"
                                acfc = 0
                            Else
                                GoTo extcase
                            End If
                        ...
                        Case 64
                            ...
                            If amount <> 0 Then
                                ...
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                'descr = txtDesc.Text & " " & "TECH SSS ER"
                            Else
                                GoTo extcase
                            End If
                        Case 65
                            ...
                            If amount <> 0 Then
                                ...
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                'descr = txtDesc.Text & " " & "TECH PHIL ER"
                            Else
                                GoTo extcase
                            End If
                        Case 66
                            ...
                            If amount <> 0 Then
                                ...
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                'descr = txtDesc.Text & " " & "TECH PAG ER"
                            Else
                                GoTo extcase
                            End If
...
extloop:
        ...
        Try
saveRetry:
            response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "basecorprt_corp", edi), GetType(Response))
        Catch ex As Exception
            If (retryCount < maxretry) Then
                retryCount += 1
                GoTo saveRetry
...
extcase:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Try
alreadysavedRetry:
                response = JsonConvert.DeserializeObject(service.alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "basecorprt_corp", edi), GetType(Response))
            Catch ex As Exception
                If (retryCount < maxretry) Then
                    retryCount += 1
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3100001, Credit - 3100001", 64, "Synergy EDI-" + ediname)
        Exit Sub
    End Sub
