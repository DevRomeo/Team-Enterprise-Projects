Public Class EDIVISAYAS_INSURANCE
    ...
    Private Sub EDIVISMIN_INSURANCE_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_INSURANCE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Insurance-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Insurance -Visayas")
            Exit Sub
        End If
...
ext:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from insurance_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'"
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - PP 3131004, PP Debit - 3100007 , PP Credit - 4600001" & vbCrLf & _
        vbCrLf & "Debit - FP 3131004, FP Debit - 3100007 , FP Credit - 4600001" & vbCrLf & _
        vbCrLf & "Debit - KPP 3131004, KPP Debit - 3100007 , KPP Credit - 4600001" & vbCrLf & _
        vbCrLf & "Debit - PPP 3131004, PPP Debit - 3100007 , PPP Credit - 4600001" & vbCrLf & _
        vbCrLf & "Debit - FPP 3131004, FPP Debit - 3100007 , FPP Credit - 4600001", 64, "Synergy EDI Visayas")
        Exit Sub
    End Sub
...
continuesave:
        ...
        sqltxt = "select * from insurance_corp where bcode = 000 and date_time > '" & _
...
extcase:
                Next r 'alter ends'
                '/--------------------ELY
                sqltxt = "Insert into insurance_corp(bcode, month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Insurance" & " " & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
...
extcase:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "IConnect"
    End Sub
