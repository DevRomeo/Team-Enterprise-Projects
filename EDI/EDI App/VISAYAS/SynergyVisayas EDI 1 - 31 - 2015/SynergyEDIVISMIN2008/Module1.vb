...
Module Module1
    ...
    'add 11-20-2014
    Public gs_serverloc As String = "Visayas PerBranch"
    Public gs_serverloc2 As String = "Visayas BaseBranch"
    Public gs_serverloc3 As String = "Visayas Jewellers"
    Public gs_version As String = "(EDI Version 4.0)"
    Public gs_version2 As String = "(Maintenance Version 4.0)"
    ...
    Public Sub Log(ByVal as_log As String)
        ...
        Call Log_Ex(as_log, strPath & "\" & Replace(CStr(Now.ToShortDateString), "/", "-") + " VISAYAS.log")
    End Sub
