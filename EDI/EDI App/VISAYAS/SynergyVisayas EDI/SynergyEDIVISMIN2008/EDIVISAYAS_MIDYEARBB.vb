...
Public Class EDIVISAYAS_MIDYEARBB
    ...
    Private Sub EDIVISMIN_MIDYEARBASEBRANCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Mid Year-" + ediname + " " & gs_serverloc2 & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "MidYear BaseBranch-" + ediname)
            Exit Sub
        End If
...
continuesave:
        ...
        For n = 0 To grd.Rows - 2
            ...
            If response.responseCode <> ResponseCode.NotFound Then            'rdr.close - x
                ...
                Application.DoEvents()
                Try
                    response = JsonConvert.DeserializeObject(service.isActionedWu_kebot(Trim(rBC), cboPeriod.Text, Format(g_month, "yyyy").ToString, edi), GetType(Response))
                Catch ex As Exception
                    MessageBox.Show(ex.Message)
                    btnGIF.Hide
                    grp.Hide
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "MidYear BaseBranch" & " " & "for" & " " & txtDesc.Text
        'service.logdb(datenow, "EDI", act, name, task, "DONE")        
        Call CheckBC_Errors()
        Try
...
ext:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Try
                response = JsonConvert.DeserializeObject(service.alreadySaved(g, cboPeriod.Text, cboYear.Text, "MidYear BaseBranch", "basemidyear_corp", "paydesc", edi), GetType(Response))
            Catch ex As Exception
                MessageBox.Show(ex.Message)
                Me.Close()
            End Try
...
ext:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "MidYear BaseBranch"
    End Sub
End Class