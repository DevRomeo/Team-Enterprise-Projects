...
extloop:
        ...
        Next
        Try
            response = JsonConvert.DeserializeObject(service.insertTransactionBase(JsonConvert.SerializeObject(transactiondata), JsonConvert.SerializeObject(editabledata), "MIDYEAR_corp", edi), GetType(Response))
        Catch ex As Exception
        ...
        Dim act As String = "EDI" & " " & "MIDYEAR_corp" & " " & "for" & " " & txtDesc.Text
        Call CheckBC_Errors()
...
alreadysaveext:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Try
                response = JsonConvert.DeserializeObject(service.alreadySavedBase(g, cboPeriod.Text, cboYear.Text, "MIDYEAR_corp", edi), GetType(Response))
            Catch ex As Exception
                MessageBox.Show(ex.Message)
                Me.Close()
            End Try
