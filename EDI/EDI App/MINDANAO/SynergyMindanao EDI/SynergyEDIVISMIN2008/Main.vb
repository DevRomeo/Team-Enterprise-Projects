...
Public Class Main
    ...
    Private Sub SaveUser()
        ...
        Dim sUser As String = "SELECT fullname,RES_ID,job_title FROM humres WHERE usr_id = '" + ls_username + "' AND res_id = '" + ls_userid + "' AND blocked = '0';"
...
ext:
    ...
    Private Sub Main_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim q As String = "SELECT RTRIM([username]),RTRIM([password]) FROM usersat WHERE progdesc = 'EDIMINDANAO' ORDER BY syscreated DESC; "
        ...
        If RDR1.HasRows Then
            ...
            End If
        Else
            MsgBox("You are not Authorized to access this application", MsgBoxStyle.Critical, "Synergy EDI MINDANAO")
            Application.Exit()
        End If
        'If RDR1.Read Then
        '    ls_username = Trim(RDR1(0).ToString)
    ...
    Private Sub Button36_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button36.Click
        'Dim adz1 As New clsdatalog
        'Dim q1 As String = "UPDATE usersat SET progdesc = 'EDIMINDANAO',syscreated='" + DateTime.Now + "' WHERE username = '" + ls_username + "'"
        'Dim RDR2 As SqlClient.SqlDataReader = Nothing
        'If Not adz1.clsConnect Then Exit Sub
        'If adz1.ErrorConnectionReading(False) Then Exit Sub
        'If Not adz1.dr(q1, RDR2) Then Exit Sub
    ...
    Private Sub btnProtectPlus_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProtectPlus.Click
        calledicategory = 45
        Dim CALLYEAFORM As New YearForm
        CALLYEAFORM.Show()
        Me.Hide()
