Public Class EDIMIN_GLOBESMART
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        If cmbGS.Text = "" Then
            MsgBox("Fill first phone Company", 16, "Synergy EDI Mindanao")
            Exit Sub
        End If
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Synergy EDI Mindanao")
            Exit Sub
        End If
...
extcase:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5330003, Credit - 3100005", 64, "Synergy EDI Mindanao")
        Exit Sub
    End Sub
