Public Class EDIMIN_PAYROLL
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        If cmbdesc.Text = "" Then
            MsgBox("Fill Payroll date description", 16, "Synergy EDI Mindanao")
            Exit Sub
        End If
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Payroll - Mindanao")
            Exit Sub
        End If
...
extcase:
                ...
                If n = grd.Rows - 2 Then
                    ...
                    db.ConnectDB(ls_connection)                     '--------------7152010-------------------'
                    db.Execute_SQLQuery(sqltxt)                     '--------------7152010-------------------'
                    db.CloseConnection()                            '--------------7152010-------------------'--New Eli Code
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        ...
        vbCrLf & "Credit - 3100001", 64, "Synergy EDI Mindanao")
        Exit Sub
    End Sub
    Public Sub DATEFUNC()
