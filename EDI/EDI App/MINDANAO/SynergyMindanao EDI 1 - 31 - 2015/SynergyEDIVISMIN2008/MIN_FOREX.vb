Public Class MIN_FOREX
    ...
    Dim missingfile As String = "MissingFile.txt"
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If CheckUnder() = False Then
            Exit Sub
        End If
        If Format(CDate(g_month), "yyyy-MM-dd") > Format(CDate(Now()), "yyyy-MM-dd") Then
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Gain-->  Debit - 3100001, Credit - 4500012 " & vbNewLine & "Loss--> Debit - 4500012, Credit - 3100001", 64, "Synergy EDI Mindanao")
        Exit Sub
    End Sub
