Public Class EDIMIN_UNUSEDSICKLEAVE
...
continuesave:
        ...
        sqltxt = "select * from BaseUnusedSickLeave_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into BaseUnusedSickLeave_corp(bcode,paydesc, month_eli, year_eli, " & _
