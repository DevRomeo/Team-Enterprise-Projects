        ...
        For n = 0 To grd.Rows - 2
            ...
            If rdr.Read Then            'rdr.close - x
                ...
                For r = 1 To 2
                    ...
                    '                            "[vervdatfak],[faktuurnr],[syscreator],[sysmodifier],[EntryGuid],[companycostcentercode],[docnumber])" & _
                    ...
                    '                           & SysCreator & "','" & SysModifier & "','" & Entryguid & "', '" & cccc & "','" & CompanyAccountCode & "')"
                    '\----------STANDARD-----------
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 6000001, Credit - 3100005", 64, "Synergy EDI Mindanao")
        Exit Sub
    End Sub
