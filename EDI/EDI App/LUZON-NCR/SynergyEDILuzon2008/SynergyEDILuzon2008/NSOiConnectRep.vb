Public Class NSOiConnectRep
    ...
    Private Sub NSOiConnectRep_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub NSOiConnectRep_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "NSOiConnect-" & gs_serverloc & " " & gs_version
    ...
    Private Sub Init_Combo()
        ...
        Dim LI_ENDDATE As Integer = Nothing
...
continuesave:
            ...
            sqltxt = "select * from NSOCONNECT_corp where bcode = 000 and date_time > '" & _
...
extcase:
                    ...
                    sqltxt = "Insert into NSOCONNECT_corp(bcode,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "NSO iConnect " & gs_version & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from NSOCONNECT_corp where month_eli = '" & cboperiod.Text & "' and year_eli = '" & cboyear.Text & "' and bcode = '" & g & "'"
    ...
    Private Function errorcostcenter() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            If Len(g).ToString < 8 Then
                MsgBox(grd.get_TextMatrix(n, 0) & " " & grd.get_TextMatrix(n, 1) & " " & "Please fill correct cost center", 64, gs_version)
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        MsgBox("Debit - 2001001, Credit - 3100002", MsgBoxStyle.OkOnly, gs_version)
    End Sub
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "NSO Iconnect"
    End Sub
End Class