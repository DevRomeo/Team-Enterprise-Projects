Public Class GlobeSmart
    ...
    Private Sub GlobeSmart_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub GlobeSmart_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "GlobeSmart-" & gs_serverloc & " " & gs_version
                        ...
                        Select Case r
                            ...
                            Case 2
                                ...
                                If acfc <> 0 Then
                                    ...
                                    cccc = Format(grd.get_TextMatrix(n, 3))
                                Else
                                    GoTo extcase
                                End If
                        End Select
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "Globe/Smart" & gs_serverloc & "for" & " " & txtdesc.Text.Trim
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            If Len(g) = 2 Then
                g = 0 & g
            End If
            Dim s As String = "Select * from globesmartbill_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' and companydesc like '" + txtdesc.Text + "'"
...
ext:
    ...
    Private Function errorcostcenter() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            Dim g As String = grd.get_TextMatrix(n, 3)
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        MsgBox("Debit - 5330003, Credit - 3100001", MsgBoxStyle.OkOnly, gs_version)
    End Sub
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "Globe / Smart"
    End Sub
End Class