Public Class FixedAssetsLuzon
    ...
    Private Sub FixedAssetsLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub FixedAssetsLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Fixed Assets-" & gs_serverloc & " " & gs_version
...
continuesave:
        ...
        sqltxt = "select * from FIXEDASSETS_corp where bcode = 000 and date_time > '" & _
                ...
                For r = 1 To 20
                    ...
                    Select Case r
                        Case 1
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5540003"
                                descr = "FFE" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 2
                        ...
                        Case 3
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5540005"
                                descr = "OFFICE EQT" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 4
                        ...
                        Case 5
                            ...
                            If amount <> 0 Then
                                ...
                                descr = "REPAIR AND MAINTENANCE" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 6
                        ...
                        Case 7
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5550001"
                                descr = "LRI" & " " & txtdesc.Text
                        ...
                        Case 9
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5540002"
                                descr = "SERVICE VEHICLE" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 10
                        ...
                        Case 11
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5460001"
                                descr = "TSHIRTS/FLYERS/PERIPHERALS" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 12
                        ...
                        Case 13
                            ...
                            If amount <> 0 Then
                                ...
                                descr = "PRINT/RADIO/SIGNS" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 14
                        ...
                        Case 15
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5540004"
                                descr = "PERIPHERALS" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 16
                        ...
                        Case 17
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5550003"
                                descr = "COMPUTER SOFTWARE" & " " & txtdesc.Text
                            Else
                                GoTo extcase
                            End If
                        Case 18
...
extcase:
                ...
                sqltxt = "Insert into FIXEDASSETS_corp(bcode,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Fixed Assets " & gs_serverloc & "for" & lblMonth.Text.Trim & " " & cboYear.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from FIXEDASSETS_corp where month_eli = '" & cboperiod.Text & "' and year_eli = '" & cboyear.Text & "' and bcode = '" & g & "'"
...
EXT:
    ...
    Private Function fillnullbcode() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            If grd.get_TextMatrix(N, 0).ToString = 0 Then
...
ext:
    ...
    Private Function errorcostcenter() As Boolean
        Dim n As Integer = Nothing
        For n = 0 To grd.Rows - 2
            Dim g As String = grd.get_TextMatrix(n, 12)
            If grd.get_TextMatrix(n, 12) = "0" Then
                GoTo EXT
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        Dim sqq = "Debit        ,Credit" & _
                  vbCrLf & "5540003  ,1110022" & _
                  vbCrLf & "5540005  ,1110024" & _
                  vbCrLf & "5350001  ,1040007" & _
                  vbCrLf & "5550001  ,1110003" & _
                  vbCrLf & "5540002  ,3100002" & _
                  vbCrLf & "5460001  ,1040002" & _
                  vbCrLf & "5460002  ,1040002" & _
                  vbCrLf & "5540004  ,1110023" & _
                  vbCrLf & "5550003  ,1120001" & _
                  vbCrLf & "5550004  ,1120004"
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "Fixed Assets"
    End Sub
End Class