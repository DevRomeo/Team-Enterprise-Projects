Public Class RRFLuzon
    ...
    Private Sub RRFLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub RRFLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "RRF-" & gs_serverloc & " " & gs_version
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            End If
            If txtdesc.Text = "" Then
                MsgBox("MONTH DESCRIPTION APPEARS TO BE NULL, PLEASE INPUT MONTH DESCRIPTION AND TRY AGAIN", 64, gs_version)
                GoTo extalreadysave
            End If
            '/-------> ELI code
...
continuesave:
            ...
            sqltxt = "select * from RRF_corp where bcode = 000 and date_time > '" & _
                ...
                If rdr.Read Then            'rdr.close - x
                    ...
                    For r = 1 To 23
                        ...
                        Select Case r
                            Case 1
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = txtdesc.Text.Trim & " " & "RM/AM SALARY"
                                Else
                                    GoTo extcase
                                End If
                            Case 2
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5230001"
                                    descr = txtdesc.Text.Trim & " " & "HMO"
                                Else
                                    GoTo extcase
                                End If
                            Case 3
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5214001"
                                    descr = txtdesc.Text.Trim & " " & "ALLOWANCE"
                            ...
                            Case 5
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = txtdesc.Text.Trim & " " & "INSURANCE"
                                Else
                                    GoTo extcase
                                End If
                            Case 6
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5410001"
                                    descr = txtdesc.Text.Trim & " " & "SSS"
                                Else
                                    GoTo extcase
                                End If
                            Case 7
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5420001"
                                    descr = txtdesc.Text.Trim & " " & "PHILHEALTH"
                                Else
                                    GoTo extcase
                                End If
                            Case 8
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5430001"
                                    descr = txtdesc.Text.Trim & " " & "PAG-IBIG"
                            ...
                            Case 9
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = txtdesc.Text.Trim & " " & "RECEIVABLE"
                                Else
                                    GoTo extcase
                                End If
                            Case 10
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = txtdesc.Text.Trim & " " & "PRODUCTIVITY"
                                Else
                                    GoTo extcase
                                End If
                            Case 11
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5280001"
                                    descr = txtdesc.Text.Trim & " " & "MID YEAR"
                                Else
                                    GoTo extcase
                                End If
                            Case 12
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5280002"
                                    descr = txtdesc.Text.Trim & " " & "13TH MONTH"
                            ...
                            Case 13
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5460002"
                                    descr = txtdesc.Text.Trim & " " & "ADS AND PROMO"
                                Else
                                    GoTo extcase
                                End If
                            Case 14
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5300001"
                                    descr = txtdesc.Text.Trim & " " & "LEGAL"
                                Else
                                    GoTo extcase
                                End If
                            Case 15
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5400001"
                                    descr = txtdesc.Text.Trim & " " & "TRAVEL"
                                Else
                                    GoTo extcase
                                End If
                            Case 16
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5440001"
                                    descr = txtdesc.Text.Trim & " " & "FUEL"
                                Else
                                    GoTo extcase
                                End If
                            Case 17
                            ...
                            Case 18
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5460005"
                                    descr = txtdesc.Text.Trim & " " & "EVENTS"
                            ...
                            Case 19
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5350001"
                                    descr = txtdesc.Text.Trim & " " & "REPAIR"
                            ...
                            Case 20
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    CompanyAccountCode = "5290001"
                                    descr = txtdesc.Text.Trim & " " & "CO./ORG"
                            ...
                            Case 21
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = txtdesc.Text.Trim & " " & "UNUSEDSL"
                            ...
                            Case 23
                                ...
                                If acfc <> 0 Then
                                    ...
                                    descr = txtdesc.Text.Trim & " " & "DUE TO/FROM MAKATI"
                                    cccc = Format(grd.get_TextMatrix(n, 25))
                                Else
                                    GoTo extcase
                                End If
                        End Select
                        ...
                        sqltxt = "INSERT INTO " & database & ".[dbo].[TransactionsPending]([paymentmethod],[freefield4],[freefield5], [CompanyCode], [TransactionType], [TransactionDate]," & _
                                                    ...
                                                    "," & acfc & ",'PHP'," & amount & "," & acfc & ",0, 1, 'B', 0, 'Z','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(g_month, "yyyy-MM-dd") & "','" & rFaktuurnr & "','" _
...
extcase:
                    ...
                    sqltxt = "Insert into RRF_corp(bcode,descs,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "RRF" & gs_serverloc & cboSheet.Text.Trim & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from RRF_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' AND DESCS = '" + txtdesc.Text.Trim + "'"
    ...
    Private Function fillnullbcode() As Boolean
        ...
        For r = Val(txtstart.Text) - 1 To g_Row - 1
            If dg.Item(r, 0).ToString = 0 Then
                num1 = InputBox(dg.Item(r, 2) & " " & "appears to have null branch code. Please input correct branchcode", gs_version).ToString
                If num1 = "" Then
                    num1 = 0
                    fillnullbcode = False
                    GoTo ext
...
ext:
        ...
        For n = 0 To grd.Rows - 2
            ...
            If Not c.Error_SetRdr(sqltxt, rdr, sqlmsg) Then
                If rdr.Read Then
                    a = rdr(0)
                Else
                    MsgBox("Missing Branch" & g & " ", gs_version)
                    missingbranch = True
                End If
            End If
        Next
    ...
    Private Function errorcostcenter() As Boolean
        Dim n As Integer = Nothing
        For n = 0 To grd.Rows - 2
            Dim g As String = grd.get_TextMatrix(n, 25)
