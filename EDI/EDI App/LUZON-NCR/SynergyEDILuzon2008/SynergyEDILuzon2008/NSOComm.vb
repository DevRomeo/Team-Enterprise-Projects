Public Class NSOComm
    ...
    Private Sub NSOComm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub NSOComm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "NSOComm-" & gs_serverloc & " " & gs_version
...
continuesave:
            ...
            sqltxt = "select * from NSOCOMM_CORP where bcode = 000 and date_time > '" & _
...
extcase:
                    ...
                    sqltxt = "Insert into NSOCOMM_CORP(bcode,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "NSO COMM " & gs_serverloc & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from NSOCOMM_CORP where month_eli = '" & cboperiod.Text & "' and year_eli = '" & cboyear.Text & "' and bcode = '" & g & "'"
...
ext:
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "NSO Commission"
    End Sub
End Class