Public Class EDIVISMIN_CORPINCOME
    ...
    Private Sub EDIVISMIN_CORPINCOME_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Corporate Income-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, gs_version)
            Exit Sub
        End If
        ...
        For n = Val(txtstart.Text) - 2 To 0 Step -1
            ...
            If Not Trim(dg.Item(n, 0).ToString) = "" Then
                ...
                Else
                    ...
                    If rdr.Read Then
                        MsgBox("Some datas have not included. Please Check Excel File", 64, gs_serverloc)
...
ext:
    ...
    Private Sub corpname()
        ...
        If Not jpoy.Error_SetRdr(sqltxt, rdr, sqlmsg) Then
            ...
            Else
                MsgBox(LI_CORPPARTNERS & " " & "THIS COMPANY DOESN'T EXIST IN THE DATABASE ", gs_version)
            End If
        End If
        rdr.Close()
        jpoy.DisposeR()
    ...
    Private Function corpexisting() As Boolean
        Dim r As Integer = Nothing
        For r = 0 To ListView1.Items.Count - 0
            If r > 61 Then 'COUNTING STARTS AT ZERO (0)
                LI_CORPPARTNERS = "DUMMY"
            Else
                LI_CORPPARTNERS = ListView1.Items(r).Text.ToString
            End If
            sqltxt = "select * from corporate_partners where corpCODE LIKE '" + LI_CORPPARTNERS + "'"
            Dim jpoy As New ClsDataEDILuzon
            Dim rdr As SqlClient.SqlDataReader = Nothing
            If jpoy.Error_Inititalize_INI Then Exit Function
            If jpoy.ErrorConnectionReading(False) Then Exit Function
            If Not jpoy.Error_SetRdr(sqltxt, rdr, sqlmsg) Then
                If rdr.Read Then
                    corpexisting = True
                Else
                    If LI_CORPPARTNERS.Contains("DUMMY") = True Then
                        corpexisting = True
                    Else
                        MsgBox(LI_CORPPARTNERS & " " & "THIS COMPANY DOES NOT EXIST IN THE DATABASE ")
                        corpexisting = False
                        rdr.Close()
                        jpoy.DisposeR()
                        Exit Function
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "EDI " & gs_serverloc)
            Exit Sub
        End If
        If corpexisting() = False Then
            GoTo extAlreadySave
        End If
        ...
        If alreadysave() = True Then
            ...
            li_input = MsgBox("This data is already been saved, Would you like to save it anyway?", MsgBoxStyle.YesNo Or MsgBoxStyle.Information, gs_version)
...
extcase:
                ...
                Else
                    SW.WriteLine(grd.get_TextMatrix(n, 1) & " Missing Branch Code", gs_version)
                    rdr.Close()
                    jpoy.DisposeR()
                End If
            End If
        ...
        Dim act As String = "EDI" & " " & "CorpIncome" & gs_serverloc & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
