Public Class TaxRemLuzon
    ...
    Private Sub TaxRemLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub TaxRemLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "TaxRem-" & gs_serverloc & " " & gs_version
...
continuesave:
            ...
            sqltxt = "select * from TAXREM_corp where bcode = 000 and date_time > '" & _
                        ...
                        Select Case r
                            Case 1
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = "TAX REM" & " " & txtdesc.Text.Trim
                                    cccc = "0" & rBC & "-" & rBC
                                Else
                                    GoTo extcase
                                End If
...
extcase:
                    ...
                    sqltxt = "Insert into TAXREM_corp(bcode,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "TAX REM" & gs_serverloc & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from TAXREM_corp where month_eli = '" & cboperiod.Text & "' and year_eli = '" & cboyear.Text & "' and bcode = '" & g & "'"
...
ext:
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "Tax Remittance"
    End Sub
End Class