Public Class XoomLuzon
    ...
    Private Sub XoomLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub XoomLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
continuesave:
            ...
            For n = 0 To grd.Rows - 2
                ...
                If rdr.Read Then            'rdr.close - x
                    ...
                    sqltxt = "select top 1 number from numbers where companycode = '" + rBC + "' and used = 0 order by number asc"
                        ...
                        Select Case r
                            Case 1
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = txtdesc.Text & " " & "DUE TO FROM XOOM"
                                    cccc = GetCostCenter(rBC)
                                Else
                                    GoTo extcase
                                End If
                            Case 2
...
extcase:
                    ...
                    '    GoTo Extsub
                    'End If
                    rdr.Close() ' NEW ELY CODE 5-6-2010
                    db.CloseConnection()
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "XOOM " & gs_serverloc & "for" & " " & txtdesc.Text.Trim
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        MsgBox("Debit - 3132004, Credit - 4220051", MsgBoxStyle.OkOnly, gs_version)
    End Sub
