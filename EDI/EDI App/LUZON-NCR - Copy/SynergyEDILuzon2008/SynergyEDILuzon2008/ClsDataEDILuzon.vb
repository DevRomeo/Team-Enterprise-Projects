Public Class ClsDataEDILuzon
    ...
    Public Function Error_Inititalize_INI() As Boolean
        Try
            ...
            If gs_serverloc = "Luzon" Then
                sr = New IO.StreamReader(Application.StartupPath & "\EDILUZON.ini")
            ElseIf gs_serverloc = "NCR" Then
                sr = New IO.StreamReader(Application.StartupPath & "\EDINCR.ini")
            End If
            ...
            While Not line Is Nothing
                ...
                If line.StartsWith("[job1]=") Then
                    ...
                    modls_jobtitle1 = ls_jobtitle1
                End If
                If line.StartsWith("[job2]=") Then
                    ls_jobtitle2 = Replace(line, "[job2]=", "")
                    modls_jobtitle2 = ls_jobtitle2
                End If
                line = sr.ReadLine
            End While
            sr.Close()
