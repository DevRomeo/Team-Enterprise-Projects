Public Class MoneyGramLuzon
    ...
    Private Sub MoneyGramLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub MoneyGramLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
continuesave:
            ...
            sqltxt = "select * from MONEYGRAMs_corp where bcode = 000 and date_time > '" & _
                        ...
                        Select Case r
                            Case 1
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = "DUE TO FROM MONEYGRAM" & " " & txtdesc.Text
...
extcase:
                    ...
                    sqltxt = "Insert into MONEYGRAMS_corp(bcode,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "Money Gram" & gs_serverloc & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from moneygrams_corp where month_eli = '" & cboperiod.Text & "' and year_eli = '" & cboyear.Text & "' and bcode = '" & g & "'"
        ...
        For n = 0 To grd.Rows - 2
            ...
            If Not c.Error_SetRdr(sqltxt, rdr, sqlmsg) Then
                If rdr.Read Then
                    a = rdr(0)
                Else
                    MsgBox(g & " " & "Missing Branch", 16, gs_version)
                    missingbranch = True
                End If
            End If
        Next
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        MsgBox("Debit - 3131004, Credit - 4220054", MsgBoxStyle.OkOnly, gs_version)
    End Sub
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "Money Gram"
    End Sub
End Class