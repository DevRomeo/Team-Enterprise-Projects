Public Class XpressMoneyLuzon
    ...
    Private Sub XpressMoneyLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New EDI_Luzon_Main
        main.Show()
    End Sub

    Private Sub XpressMoneyLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
continuesave:
            ...
            sqltxt = "select * from XPRESSMONEY_corp where bcode = 000 and date_time > '" & _
...
extcase:
                    ...
                    sqltxt = "Insert into XPRESSMONEY_corp(bcode,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "Xpress Money" & gs_serverloc & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from XPRESSMONEY_corp where month_eli = '" & cboperiod.Text & "' and year_eli = '" & cboyear.Text & "' and bcode = '" & g & "'"
...
ext:
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "Xpess Money"
    End Sub
End Class