Public Class EDIVISMIN_MMD
    ...
    Private Sub EDIVISMIN_MMD_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_MMD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "MMD-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Mid Year - Showroom")
            Exit Sub
        End If
...
continuesave:
        ...
        For n = 0 To grd.Rows - 2
            ...
            If rdr.Read Then            'rdr.close - x
                ...
                End If                      '--------------7152010-------------------'
                db.ConnectDB(ls_connection)             '--------------7152010-------------------'
                rdr = db.Execute_SQL_DataReader(sqltxt) '-
                'If c.Error_SetRdr(sqltxt, rdr, sqlmsg) Then
                '    f.Error_Log(f.ErrTxt(sqltxt, sqlmsg), g_errLog)
                '    GoTo Extsub
                'End If
                ...
                For r = 1 To 9
                    ...
                    Select Case r
                        ...
                        Case 2
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "1110006"
                                descr = "Computer" & " " & Label7.Text
                            Else
                                GoTo extcase
                            End If
                        Case 3
                        ...
                        Case 4
                            ...
                            If amount <> 0 Then
                                ...
                                descr = "Appraisal Tools" & " " & Label7.Text
                            Else
                                GoTo extcase
                            End If
                        Case 5
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "1110005"
                                descr = "FFE" & " " & " " & Label7.Text
                            Else
                                GoTo extcase
                            End If
                        Case 6
                        ...
                        Case 7
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "1110007"
                                descr = "Office" & " " & Label7.Text
                            Else
                                GoTo extcase
                            End If
                        Case 8
                        ...
                        Case 9
                            ...
                            If acfc <> 0 Then
                                ...
                                descr = "H.O Expense" & " " & Label7.Text
                                cccc = grd.get_TextMatrix(n, 11)
                            Else
                                GoTo extcase
                            End If
                    End Select
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "MMD" & " " & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            If Len(g) < 2 Then
                g = "00" & g
            End If
            Dim s As String = "Select * from MMD_corp where month_eli like '" & cboPeriod.Text & "' and year_eli like '" & cboYear.Text & "' and bcode like '" & g & "'"
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        ...
        MsgBox("Debit -  5340001,  Debit - 1110006 , Debit - 5340001" & vbCrLf & _
       vbCrLf & "Debit - 5480001,  Debit - 1110005 , Debit - 5460004" & vbCrLf & _
       vbCrLf & "Debit - 1110007,  Debit - 1110005 , Credit - 3100005", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
