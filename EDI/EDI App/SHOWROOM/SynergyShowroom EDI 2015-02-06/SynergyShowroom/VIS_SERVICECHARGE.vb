Public Class VIS_SERVICECHARGE
    ...
    Private Sub VIS_SERVICECHARGE_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub VIS_SERVICECHARGE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        grp.Hide()
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "Synergy EDI Vismin")
            Exit Sub
        End If
...
continuesave:
        ...
        sqltxt = "select * from NCLSERVICECHARGE_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into NCLSERVICECHARGE_corp(bcode,monthdesc,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "NCL-Service Charge" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "EDI - Vismin")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To GRD.Rows - 2
            ...
            Dim s As String = "Select * from NCLSERVICECHARGE_corp where month_eli like '" & cboPeriod.Text & "' and year_eli like '" & cboYear.Text & "' and bcode like '" & g & "' and monthdesc like '" + lblMonth.Text + "'"
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3131004, Credit - 4220054", 64, "Synergy EDI Vismin")
        Exit Sub
    End Sub
...
extcase:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "NCL SERVICE CHARGE"
