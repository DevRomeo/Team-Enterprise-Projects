Public Class VIS_PRINCIPAL
    ...
    Private Sub VIS_PRINCIPAL_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub VIS_PRINCIPAL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        grp.Hide()
...
continuesave:
        ...
        sqltxt = "select * from NCLPRINCIPAL_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into NCLPRINCIPAL_corp(bcode,monthdesc,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "NCL-Principal" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To GRD.Rows - 2
            ...
            Dim s As String = "Select * from NCLPRINCIPAL_corp where month_eli like '" & cboPeriod.Text & "' and year_eli like '" & cboYear.Text & "' and bcode like '" & g & "' and monthdesc like '" + lblMonth.Text + "'"
...
extcase:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "NCL PRINCIPAL"
