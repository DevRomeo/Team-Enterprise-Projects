Public Class EDIVISMIN_UNUSED_SICKLEAVE
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Unused Sick Leave - Showroom")
            Exit Sub
        End If
...
continuesave:
        ...
        sqltxt = "select * from UnusedSickLeave_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into UnusedSickLeave_corp(bcode,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "UnusedSickleave Base Branch" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from UnusedSickLeave_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' "
...
extcase:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5270001, Credit - 3100001", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
