Public Class EDIReportLuzon
    ...
    Private Sub EDIReportLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "EDI Report-" & gs_serverloc3 & " " & gs_version
        cboSet.Text = "False"
        Call Me.Init_Combo()
        btnSave.Hide()
        picGif.Hide()
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtdesc.Text = "" Then
            MsgBox("MONTH DESCRIPTION APPEARS TO BE NULL, PLEASE INPUT MONTH DESCRIPTION AND TRY AGAIN", 64, "EDI - REPORT")
            GoTo extalreadysave
        End If
        '/-------> ELI code
...
continuesave:
        ...
        sqltxt = "select * from EDIREPORT_corp where bcode = 000 and date_time > '" & _
                          Format(g_month, "yyyy-MM-dd") & "'"

        'Newly added code by ching2
...
extcase:
                ...
                sqltxt = "Insert into EDIREPORT_corp(bcode,descs,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "EDI/REPORTS Jewellers" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from EDIREPORT_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' AND DESCS = '" + txtdesc.Text + "'"
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        Dim sqq = "Debit        ,Credit" & _
                  ...
                  vbCrLf & "5530002  " & _
                  vbCrLf & "5530001  "
        MsgBox(sqq, MsgBoxStyle.OkOnly, "Synergy Showroom EDI Report")
    End Sub
