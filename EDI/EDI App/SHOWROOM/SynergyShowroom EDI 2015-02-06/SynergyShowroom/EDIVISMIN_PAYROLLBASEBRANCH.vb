Public Class EDIVISMIN_PAYROLLBASEBRANCH
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Payroll BB - Showroom")
            Exit Sub
        End If
...
ext:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "Payroll BB - Showroom")
        Else
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        MsgBox("Debit - 3131004, Credit - 4220054", 64, "Payroll BB Showroom")
        Exit Sub
    End Sub
