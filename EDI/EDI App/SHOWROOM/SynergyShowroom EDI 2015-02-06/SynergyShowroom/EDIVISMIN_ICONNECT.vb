Public Class EDIVISMIN_ICONNECT
    ...
    Private Sub EDIVISMIN_ICONNECT_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_ICONNECT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "IConnect-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If Me.TEXTBOX1.Text = "" Then
            MsgBox("Browse File First", 16, "IConnect")
            Exit Sub
        End If
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "IConnect")
            Exit Sub
        End If
        ...
        For n = Val(txtstart.Text) - 2 To 0 Step -1
            ...
            If Not Trim(dg.Item(n, 0).ToString) = "" Then
                ...
                Else
                    ...
                    If rdr.Read Then
                        MsgBox("Some datas have not included. Please Check Excel File", 64, "IConnect")
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "IConnect")
            Exit Sub
        End If
        ...
        Dim descr As String = "ICONNECT " + " " + txtDesc.Text
...
continuesave:
        ...
        sqltxt = "select * from ICONNECT_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into ICONNECT_corp(bcode,month_eli, year_eli, " & _
...
extalreadysave:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "IConnect")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from ICONNECT_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = " & g & " "
    ...
    Private Function dualbranch() As Boolean
        ...
        Dim loc1 As String = Nothing
        Dim loc2 As String = Nothing
        For n = 0 To grd.Rows - 1
            loc1 = grd.get_TextMatrix(n, 1)
...
ext:
                If num1 = num2 Then
                    MsgBox("Dual Branch" & " " & num1 & " " & loc1 & " " & num2 & " " & loc2, 64, "IConnect-" & gs_serverloc & " " & gs_version)
                    dualbranch = True
                End If
            Next
        Next
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3160001, Debit - 4410001, Credit - 2001001", 64, "IConnect")
        Exit Sub
    End Sub
