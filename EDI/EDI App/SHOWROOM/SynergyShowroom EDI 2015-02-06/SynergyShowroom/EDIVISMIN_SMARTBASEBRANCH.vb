Public Class EDIVISMIN_SMARTBASEBRANCH
    ...
    Private Sub EDIVISMIN_SMARTBASEBRANCH_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_SMARTBASEBRANCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Smart Bill-" & gs_serverloc2 & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "SmartBill BB - Showroom")
            Exit Sub
        End If
...
extcase:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "SmartBill BB - Showroom")
            Exit Sub
        End If
                    ...
                    Select Case r
                        Case 1
                            ...
                            If amount <> 0 Then
                                ...
                                descr = Format(grd.get_TextMatrix(n, 15)) & " SMART BILL" & " " & txtDesc.Text
                        ...
                        Case 2
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 16)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 3
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 17)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 4
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 18)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 5
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 19)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 6
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 20)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 7
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 21)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 8
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 22)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 9
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 23)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 10
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 24)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 11
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 25)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 12
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 26)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
                        Case 13
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 27)) & " SMART BILL" & " " & txtDesc.Text
                                cccc = Format(grd.get_TextMatrix(n, 28))
                            Else
                                GoTo extcase
                            End If
...
extcase:
                ...
                sqltxt = "Insert into smart3_corp(bcode,companydesc,month_eli, year_eli, " & _
                         ...
                         "','SMART','" & Format(g_month, "MM").ToString & "', '" & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Smart" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "SmartBill BB - Showroom")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from smart3_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' and companydesc = 'SMART'"
...
ext:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Smart Base Branch"
    End Sub
End Class