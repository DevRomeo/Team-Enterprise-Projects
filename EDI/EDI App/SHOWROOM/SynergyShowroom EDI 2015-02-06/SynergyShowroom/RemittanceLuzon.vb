Public Class RemittanceLuzon
    ...
    Private Sub RemittanceLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        End
    End Sub

    Private Sub RemittanceLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Remittance-" & gs_serverloc3 & " " & gs_version
...
continuesave:
            ...
            sqltxt = "select * from rt_corp where bcode = 000 and date_time > '" & _
                    ...
                    For r = 1 To 9
                        ...
                        Select Case r
                            Case 1
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    descr = "SSS REM" & " " & txtdesc.Text.Trim
                            ...
                            Case 2
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    descr = "SSS EXPENSE" & " " & txtdesc.Text.Trim
                            ...
                            Case 3
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    descr = "PAG-IBIG REM" & " " & txtdesc.Text.Trim
                            ...
                            Case 4
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = "PAG-IBIG EXPENSE" & " " & txtdesc.Text.Trim
                                Else
                                    GoTo extcase
                                End If
                            Case 5
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    descr = "PHILHEALTH REM" & " " & txtdesc.Text.Trim
                            ...
                            Case 6
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    descr = "PHILHEALTH EXPENSE" & " " & txtdesc.Text.Trim
                            ...
                            Case 7
                                ...
                                If amount <> 0 Then
                                    acfc = 0
                                    descr = "HMO REM" & " " & txtdesc.Text.Trim
                            ...
                            Case 8
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = "HMO EXPENSE" & " " & txtdesc.Text.Trim
                                Else
                                    GoTo extcase
                                End If
                            Case 9
                                ...
                                If acfc <> 0 Then
                                    ...
                                    descr = "DUE TO/FROM MAKATI" & " " & txtdesc.Text.Trim
                                    cccc = Format(grd.get_TextMatrix(n, 11))
                                Else
                                    GoTo extcase
                                End If
                        End Select
                        ...
                        If db.Execute_SQLQuery(sqltxt) < 1 Then                                         '--------------7152010-------------------'
                            ...
                            db.CloseConnection()                                                        '--------------7152010-------------------'
                            MsgBox("Error in processing data", MsgBoxStyle.Critical, "System Error")    '--------------7152010-------------------'
                            Exit Sub                                                                    '--------------7152010-------------------'
                        End If                                                                          '--------------7152010-------------------'
                        db.CloseConnection()
...
extcase:
                    ...
                    sqltxt = "Insert into rt_corp(bcode,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "Remittance Jewellers" & " " & cboSheet.Text.Trim & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from rt_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' "
...
ext:
    ...
    Private Function errorcostcenter() As Boolean
        Dim n As Integer = Nothing
        For n = 0 To grd.Rows - 2
            Dim g As String = Format(grd.get_TextMatrix(n, 11))
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        Dim sqq = "Debit             ,Credit" & _
                  ...
                  vbCrLf & "2070006  " & _
                  vbCrLf & "5230001  "
        MsgBox(sqq, MsgBoxStyle.OkOnly, "Synergy Showroom Remittance")
    End Sub
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "Remittance"
    End Sub
End Class