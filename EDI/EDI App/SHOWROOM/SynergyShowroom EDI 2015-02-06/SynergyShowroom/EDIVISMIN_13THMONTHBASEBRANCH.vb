Public Class EDIVISMIN_13THMONTHBASEBRANCH
    ...
    Private Sub EDIVISMIN_13THMONTHBASEBRANCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "13th Month-" & gs_serverloc2 & " " & gs_version
        grp.Hide()
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "13th Month BB - Showroom")
            Exit Sub
        End If
        Dim n As Integer = Nothing
        Dim r As Integer = Nothing
...
continuesave:
        ...
        sqltxt = "select * from basethirmonth_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into basethirmonth_corp(bcode,paydesc, month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "BASE 13Th Month" & " " & "for" & " " & txtDesc.Text
...
ext:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "13th Month BB - Showroom")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim squery As String = "Select * from basethirmonth_corp where paydesc = '" & paydesc & "' and month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'  "
...
ext:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "13th Month Base Branch"
    End Sub
End Class
