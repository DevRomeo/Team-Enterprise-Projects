Public Class Luzon_SSMI
    ...
    Private Sub SSMI_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    '    'EDI_Luzon_Main.Show()
    'End Sub
    Private Sub SSMI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "SSMI-" & gs_serverloc3 & " " & gs_version
...
extcase:
                    ...
                    sqltxt = "Insert into ssmi_corp(bcode, month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "SSMI" & gs_serverloc & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from ssmi_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = " & g & ""
    ...
    Private Function errorcostcenter() As Boolean
        Dim n As Integer = Nothing
        For n = 0 To grd.Rows - 2
            Dim g As String = GRD.get_TextMatrix(n, 6)
...
extcase:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        MsgBox("Debit - 5370003, Credit - 3100002", MsgBoxStyle.OkOnly, gs_version)
    End Sub
