Public Class EDIVISMIN_UNUSEDSICKLEAVE_BASEBRANCH
    ...
    Private Sub EDIVISMIN_UNUSEDSICKLEAVE_BASEBRANCH_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    
    Private Sub EDIVISMIN_UNUSEDSICKLEAVE_BASEBRANCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Unused SickLeave-" & gs_serverloc2 & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Unused SickLeave BB")
            Exit Sub
        End If
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "Unused SickLeave BB - Showroom")
            Exit Sub
        End If
        Dim n As Integer = Nothing
        Dim r As Integer = Nothing
                    ...
                    Select Case r
                        ...
                        Case 58
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "Unused Sick Leave"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 169)))
                                CompanyAccountCode = "3100001"
                            Else
                                GoTo extcase
                            End If
                        ...
                        Case 65
                            ...
                            If amount <> 0 Then
                                ...
                                descr = "Unused Sick Leave"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 168)))
                            Else
                                GoTo extcase
                            End If
                        Case 66
...
extcase:
                ...
                sqltxt = "Insert into basecorpallo_corp(bcode,paydesc, month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "BASE Unused Sickleave" & " " & "for" & " " & txtDesc.Text
...
ext:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "Unused SickLeave BB - Showroom")
        Else
...
ext:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Unused Sick Leave Base Branch"
    End Sub
End Class