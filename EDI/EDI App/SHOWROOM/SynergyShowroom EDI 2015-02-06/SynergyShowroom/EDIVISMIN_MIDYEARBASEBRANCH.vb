Public Class EDIVISMIN_MIDYEARBASEBRANCH
    ...
    Private Sub EDIVISMIN_MIDYEARBASEBRANCH_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_MIDYEARBASEBRANCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Mid Year-" & gs_serverloc2 & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Mid Year BB - Showroom")
            Exit Sub
        End If
            ...
            For r = 1 To 111
                ...
                Select Case r
                    ...
                    Case 79
                        ...
                        '\-------------------------Start at EI/
                    Case 80
                        acfc = Format(grd.get_TextMatrix(n, 140)) 'new eli
                        If acfc <> 0 Then
                            amount = 0
...
extcase:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "Synergy EDI Showroom")
            Exit Sub
        End If
        Dim n As Integer = Nothing
        Dim r As Integer = Nothing
...
continuesave:
        ...
        sqltxt = "select * from basecorpallo_corp where bcode = 000 and date_time > '" & _
                ...
                For r = 1 To 111
                    ...
                    Select Case r
                        ...
                        Case 59
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                'descr = "Mid Year" & " " & txtdesc.text & " " & "IAD Salaries"
                                CompanyAccountCode = "3100001"
                        ...
                        Case 60
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "IAD SAL" & " " & txtDesc.Text & " " & "IAD Salaries"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                            Else
                                GoTo extcase
                            End If
                        Case 61
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "IAD ALLOW" & " " & txtDesc.Text & " " & "IAD Allow"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                            Else
                                GoTo extcase
                        ...
                        Case 62
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "IAD OT" & " " & txtDesc.Text & " " & "IAD OT"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                            Else
                                GoTo extcase
                        ...
                        Case 63
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "IAD COLA" & " " & txtDesc.Text & " " & "IAD Cola"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 64
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "IAD PB/EXCESS" & " " & txtDesc.Text & " " & "IAD PB/Excess PB"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 65
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "IAD SAL ADJ" & " " & txtDesc.Text & " " & "IAD Sal Adj"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 66
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "IAD REC INC" & " " & txtDesc.Text & " " & "IAD Rec Inc"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 67
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "TECH SAL" & " " & txtDesc.Text & " " & "Tech Sal"
                        ...
                        Case 68
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "TECH ALLOW" & " " & txtDesc.Text & " " & "Tech Allow"
                                CompanyAccountCode = "2010002"
                        ...
                        Case 69
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "TECH OT" & " " & txtDesc.Text & " " & "Tech OT"
                                CompanyAccountCode = "2010002"
                        ...
                        Case 70
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "TECH COLA" & " " & txtDesc.Text & " " & "Tech Cola"
                                CompanyAccountCode = "2010002"
                        ...
                        Case 71
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "TECH PB EXCESS" & " " & txtDesc.Text & " " & "Tech pb/excess pb"
                        ...
                        Case 72
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "TECH SAL ADJ" & " " & txtDesc.Text & " " & "Tech Sal Adj"
                                CompanyAccountCode = "2010002"
                        ...
                        Case 73
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "TECH REC INC" & " " & txtDesc.Text & " " & "Tech Rec Inc"
                                CompanyAccountCode = "2010002"
                        ...
                        Case 74
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "MESS SAL" & " " & txtDesc.Text & " " & "Mess Salaries"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                        ...
                        Case 75
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "MESS ALLOW" & " " & txtDesc.Text & " " & "Mess Allow"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                        ...
                        Case 76
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "MESS OT" & " " & txtDesc.Text & " " & "Mess OT"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                        ...
                        Case 77
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "MESS PB/EXCESS" & " " & txtDesc.Text & " " & "Mess pb/Excess pb"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                        ...
                        Case 78
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "MESS SAL ADJ" & " " & txtDesc.Text & " " & "Mess Sal Adj"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                            Else
                                GoTo extcase
                        ...
                        Case 79
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "MESS REC INC" & " " & txtDesc.Text & " " & "Mess Rec Inc"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                            Else
                                GoTo extcase
                        ...
                        Case 80
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "IAD LATE" & " " & txtDesc.Text & " " & "IAD Late"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                            Else
                                GoTo extcase
                        ...
                        Case 81
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "IAD LEAVE" & " " & txtDesc.Text & " " & "IAD Leave"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                            Else
                                GoTo extcase
                        ...
                        Case 82
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "TECH LATE" & " " & txtDesc.Text & " " & "Tech Late"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                            Else
                                GoTo extcase
                        ...
                        Case 83
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "TECH LEAVE" & " " & txtDesc.Text & " " & "Tech Leave"
                                CompanyAccountCode = "2010002"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                            Else
                                GoTo extcase
                        ...
                        Case 84
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "MESS LATE" & " " & txtDesc.Text & " " & "Mess Late"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                            Else
                                GoTo extcase
                        ...
                        Case 85
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "MESS LEAVE" & " " & txtDesc.Text & " " & "Mess Leave"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 172)))
                            Else
                                GoTo extcase
                        ...
                        Case 87
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SSS CONT" & " " & txtDesc.Text & " " & "SSS Cont"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 88
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SSS LOAN" & " " & txtDesc.Text & " " & "SSS Loan"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 89
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "PAG CONT" & " " & txtDesc.Text & " " & "Pag Cont"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 90
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "PAG LOAN" & " " & txtDesc.Text & " " & "Pag Loan"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 91
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "COATED" & " " & txtDesc.Text & " " & "Coated"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 93
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "CANTEEN" & " " & txtDesc.Text & " " & "Canteen"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 94
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "DED 1" & " " & txtDesc.Text & " " & "DED 1"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 95
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "DED 2" & " " & txtDesc.Text & " " & "DED 2"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 96
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "ML FUND" & " " & txtDesc.Text & " " & "ML Fund"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 98
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "OVER APP" & " " & txtDesc.Text & " " & "Over Appraisal"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 99
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "COOP RECLA" & " " & txtDesc.Text & " " & "Coop Recla"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 100
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "FILMA LENDING" & " " & txtDesc.Text & " " & "Filma Lending"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 101
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "INST ACCT" & " " & txtDesc.Text & " " & "Install Acct"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 102
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "DALTAN TICKET" & " " & txtDesc.Text & " " & "Daltan Ticket"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 103
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SMART/PLDT" & " " & txtDesc.Text & " " & "Smart/PLDT"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 104
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SAKO PROVI" & " " & txtDesc.Text & " " & "Sako Provi"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 105
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SAKO COMM" & " " & txtDesc.Text & " " & "Sako Comm"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 106
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SAKO PRIME" & " " & txtDesc.Text & " " & "Sako Prime"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 107
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SAKO EMERG" & " " & txtDesc.Text & " " & "Sako Emerg"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 108
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SAKO PCASH" & " " & txtDesc.Text & " " & "Sako PCash"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 109
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SAKO CAPB" & " " & txtDesc.Text & " " & "Sako Capb"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 110
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "SAKO SAVINGS" & " " & txtDesc.Text & " " & "Sako Savings"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                        ...
                        Case 111
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "NET PAY" & " " & txtDesc.Text & " " & "Net Pay"
                                CompanyAccountCode = "3100001"
                                cccc = Trim(Format(grd.get_TextMatrix(n, 173)))
                    ...
                    sqltxt = "INSERT INTO " & database & ".[dbo].[TransactionsPending]([paymentmethod],[freefield4],[freefield5], [CompanyCode], [TransactionType], [TransactionDate]," & _
                                                ...
                                                "[vervdatfak],[faktuurnr],[syscreator],[sysmodifier],[EntryGuid],[companycostcentercode],[BranchNo])" & _
...
extcase:
                ...
                sqltxt = "Insert into basemidyear_corp(bcode,paydesc, month_eli, year_eli, " & _
...
extloop:
        ...
        Dim cls As New LogsEDIVISMIN
        Dim rdr1 As SqlClient.SqlDataReader = Nothing
        Dim act As String = "EDI" & " " & "MID YEAR" & " " & "for" & " " & txtDesc.Text
...
ext:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "EDI BaseBranch - Showroom")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim paydesc As String = txtDesc.Text
            Dim squery As String = "Select * from basemidyear_corp where paydesc = '" & paydesc & "' and month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'  "
...
ext:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Mid Year Base Branch"
    End Sub
End Class