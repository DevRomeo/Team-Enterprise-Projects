Public Class EDIVISMIN_REVOLVING_FUND
    ...
    Private Sub EDIVISMIN_REVOLVING_FUND_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_REVOLVING_FUND_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Revolving Fund-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Revolving Fund - Showroom")
            Exit Sub
        End If
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim descr As String '= cmbGS.Text & " " & " BILL"
...
continuesave:
        ...
        sqltxt = "select * from mealallowance2_corp where bcode = 000 and date_time > '" & _
                    ...
                    Select Case r
                        Case 1
                            ...
                            If amount <> 0 Then
                                ...
                                descr = Format(grd.get_TextMatrix(n, 8)) & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 14))
                            Else
                                GoTo extcase
                            End If
                        Case 2
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 9)) & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 14))
                            Else
                                GoTo extcase
                            End If
                        Case 3
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 10)) & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 14))
                            Else
                                GoTo extcase
                            End If
                        Case 4
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 11)) & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 14))
                            Else
                                GoTo extcase
                            End If
                        Case 5
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 12)) & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 14))
                            Else
                                GoTo extcase
                            End If
                        Case 6
                            ...
                            If amount <> 0 Then
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = Format(grd.get_TextMatrix(n, 13)) & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 14))
                            Else
                                GoTo extcase
                            End If
                        Case 7
                            ...
                            If acfc <> 0 Then
                                ...
                                amount = 0
                                descr = "Meal Allow" & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 16))
                            Else
                                GoTo extcase
                            End If
                    End Select
...
extcase:
                ...
                sqltxt = "Insert into mealallowance_corp(bcode,monthdesc,month_eli, year_eli, " & _
                ...
                End If                                                                          '--------------7152010-------------------'
                db.CloseConnection()
                '------------------------/to be commented to save to other database

                'Call SaveToOtherDataBase() 'not to be commented to save to other database
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Meal Allowance" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from mealallowance2_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' and monthdesc = '" + lblMonth.Text + "'"
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3100001, Credit - 3100005", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Revolving Fund"
