        ...
        For n = 0 To grd.Rows - 2
            ...
            If rdr.Read Then            'rdr.close - x
                ...
                For r = 1 To 2
                    ...
                    End If
                    '/----------STANDARD-----------
                    'sqltxt = "INSERT INTO [synergyvismin].[dbo].[TransactionsPending]([paymentmethod],[freefield4],[freefield5], [CompanyCode], [TransactionType], [TransactionDate]," & _
                    ...
                    '                            "[vervdatfak],[faktuurnr],[syscreator],[sysmodifier],[EntryGuid],[companycostcentercode],[BranchNo],[docnumber])" & _
                    ...
                    '                           & SysCreator & "','" & SysModifier & "','" & Entryguid & "', '" & cccc & "','" & BatchN & "','" & CompanyAccountCode & "')"
                    '\----------STANDARD-----------
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 6000001, Credit - 3100005", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
