Public Class EDIVISMIN_13THMONTH
    ...
    Private Sub EDIVISMIN_13THMONTH_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_13THMONTH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "13th Month-" & gs_serverloc & " " & gs_version
        grp.Hide()
...
extcase:
                ...
                sqltxt = "Insert into thirmonth_corp(bcode,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "13Th Month" & " " & "for" & " " & txtDesc.Text
...
alreadysaveext:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "13th Month - Showroom")
            Button3.Show()
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim squery As String = "Select * from thirmonth_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'  "
...
ext:
                If num1 = num2 Then
                    MsgBox("Dual Branch" & " " & num1 & " " & loc1 & " " & num2 & " " & loc2, 64, "13th Month-" & gs_version)
                    dualbranch = True
                End If
            Next
        Next
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 2010002, Credit - 3100001", 64, "13th Month")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "13TH MONTH"
    End Sub
End Class