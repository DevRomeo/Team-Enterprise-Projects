Public Class EDIVISMIN_ICONNECT_REPL
    ...
    Private Sub EDIVISMIN_ICONNECT_REPL_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_ICONNECT_REPL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "IConnect Replenish-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "IConnect Replenishment - Showroom")
            Exit Sub
        End If
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim descr As String = "Iconnect Repl" & " " & txtDesc.Text
...
continuesave:
        ...
        sqltxt = "select * from ICONNECT_REPLENISH where bcode = 000 and date_time > '" & _
                    ...
                    Select Case r
                        ...
                        Case 2
                            ...
                            If acfc <> 0 Then
                                ...
                                cccc = Format(grd.get_TextMatrix(n, 4))
                                'cccc = GetCostCenter(bcode)
                            Else
                                GoTo extcase
                            End If
                            'Case 3
                            '    cccc = Format(grd.get_TextMatrix(n, 4)) 'new eli
                            '    If acfc <> 0 Then
                            '        amount = 0
                            '        CompanyAccountCode = "2001001"
                            '        'cccc = GetCostCenter(bcode)
...
extcase:
                ...
                sqltxt = "Insert into ICONNECT_REPLENISH(bcode,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "iConnect" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from ICONNECT_REPLENISH where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = " & g & " "
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 2001001, Credit - 3100002", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "IConnect - Replenishment"
    End Sub
End Class