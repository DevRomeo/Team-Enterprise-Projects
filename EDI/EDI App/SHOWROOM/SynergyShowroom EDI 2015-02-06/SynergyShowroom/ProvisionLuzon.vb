Public Class ProvisionLuzon
    ...
    Private Sub ProvisionLuzon_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        End
    End Sub

    Private Sub ProvisionLuzon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Provision-" & gs_serverloc3 & " " & gs_version
...
continuesave:
            ...
            sqltxt = "select * from PROVISION_corp where bcode = 000 and date_time > '" & _
                        ...
                        Select Case r
                            Case 1
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = "MID YEAR BONUS" & " " & txtdesc.Text.Trim
                            ...
                            Case 2
                                ...
                                If amount <> 0 Then
                                    ...
                                    descr = "13TH MONTH" & " " & txtdesc.Text.Trim
                                    cccc = grd.get_TextMatrix(n, 5)
                                Else
                                    GoTo extcase
                                End If
                            Case 3
                                ...
                                If acfc <> 0 Then
                                    amount = 0
                                    descr = "ACCRUED EXPENSE BONUS" & " " & txtdesc.Text.Trim
...
extcase:
                    ...
                    sqltxt = "Insert into PROVISION_corp(bcode,Monthdesc,month_eli, year_eli, " & _
...
extloop:
            ...
            Dim act As String = "EDI" & " " & "Provision Jewellers" & " " & "for" & " " & txtdesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from PROVISION_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'"
...
ext:
    ...
    Private Sub Label7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label7.Click
        Dim sqq = "Debit             ,Credit" & _
                  vbCrLf & "5280001       ,2010002" & _
                  vbCrLf & "5280002  "
        MsgBox(sqq, MsgBoxStyle.OkOnly, "Synergy Showroom Provision")
    End Sub
    ...
    Private Sub txtdesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdesc.TextChanged
        Label8.Text = txtdesc.Text & " " & "Provision"
    End Sub
End Class