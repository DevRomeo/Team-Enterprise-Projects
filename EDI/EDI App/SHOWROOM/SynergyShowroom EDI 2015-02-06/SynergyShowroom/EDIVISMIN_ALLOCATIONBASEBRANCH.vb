Public Class EDIVISMIN_ALLOCATIONBASEBRANCH
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Allocation - Showroom")
            Exit Sub
        End If
        ...
        For n = 0 To grd.Rows - 2
            ...
            If rdr.Read Then            'rdr.close - x
                ...
                For r = 1 To 66
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 122))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 42
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 123))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 43
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 124))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 44
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 125))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 45
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 126))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 46
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 127))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 47
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 134))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 135))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 136))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 56
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 137))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 57
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 138))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 139))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 59
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 140))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 60
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 141))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 142))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 62
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 143))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 63
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 144))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 64
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 145))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 65
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 146))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 66
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 147))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 67
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 148))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 68
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 149))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 69
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 150))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 70
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 151))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 71
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 152))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 72
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 153))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 73
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 154))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 74
                    ...
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 155))
                    '            Else
                    '                GoTo extcase
                    '            End If

                    '        Case 75
                    '            amount = Format(grd.get_TextMatrix(n, 76))
                    '            If amount <> 0 Then
                    '                acfc = 0

                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 156))
                    '            Else
                    '                GoTo extcase
                    '            End If

                    '        Case 76
                    '            amount = Format(grd.get_TextMatrix(n, 77))
                    '            If amount <> 0 Then
                    '                acfc = 0

                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 157))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 77
                    '            amount = Format(grd.get_TextMatrix(n, 78))
                    '            If amount <> 0 Then
                    '                acfc = 0

                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 158))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 78
                    '            amount = Format(grd.get_TextMatrix(n, 79))
                    '            If amount <> 0 Then
                    '                acfc = 0

                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 159))
                    '            Else
                    '                GoTo extcase
                    '            End If

                    '        Case 79
                    '            amount = Format(grd.get_TextMatrix(n, 80))
                    '            If amount <> 0 Then
                    '                acfc = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 160))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 80
                    '            amount = Format(grd.get_TextMatrix(n, 81))
                    '            If amount <> 0 Then
                    '                acfc = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 161))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '            '\-----------------End of debit/
                    '        Case 81
                    '            acfc = Format(grd.get_TextMatrix(n, 162))
                    '            If acfc <> 0 Then
                    '                amount = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 168))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    ...
                    '        Case 82
                    '            acfc = Format(grd.get_TextMatrix(n, 163))
                    '            If acfc <> 0 Then
                    '                amount = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 169))
                    '            Else
                    '                GoTo extcase
                    '            End If

                    '        Case 83
                    '            acfc = Format(grd.get_TextMatrix(n, 164))
                    '            If acfc <> 0 Then
                    '                amount = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 170))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 84
                    '            acfc = Format(grd.get_TextMatrix(n, 165))
                    '            If acfc <> 0 Then
                    '                amount = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 171))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 85
                    '            acfc = Format(grd.get_TextMatrix(n, 166))
                    '            If acfc <> 0 Then
                    '                amount = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 172))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '        Case 86
                    '            acfc = Format(grd.get_TextMatrix(n, 167))
                    '            If acfc <> 0 Then
                    '                amount = 0
                    '                descr = "ALLO" & " " & txtDesc.Text
                    '                CompanyAccountCode = "3100001"
                    '                cccc = Format(grd.get_TextMatrix(n, 173))
                    '            Else
                    '                GoTo extcase
                    '            End If
                    '    End Select
...
extalreadysave:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "EDI - Showroom")
        Else
