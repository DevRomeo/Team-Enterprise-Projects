Public Class EDIVISMIN_REMITTANCEBASEBRANCH
    ...
    Private Sub EDIVISMIN_REMITTANCEBASEBRANCH_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_REMITTANCEBASEBRANCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Remittance-" & gs_serverloc2 & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Remittance BB - Showroom")
            Exit Sub
        End If
...
continuesave:
        ...
        sqltxt = "select * from basecorprt_corp where bcode = 000 and date_time > '" & _
        ...
        "WHERE (BCODE = '" & Trim(rBC) & _
         ...
         " AND YEAR_ERN = " & Format(g_month, "yyyy").ToString & "))"
                ...
                For r = 1 To 67
                    ...
                    descr = "REM " & " " & Me.lblMonth.Text & " " & Me.cboYear.Text
                    Select Case r
                        Case 1
                        ...
                        Case 61
                            amount = Format(grd.get_TextMatrix(n, 122))
                            If amount <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 130)))
                                CompanyAccountCode = "3100001"
                                descr = "IAD SSS ER"
                                acfc = 0
                            Else
                        ...
                        Case 62
                            amount = Format(grd.get_TextMatrix(n, 123))
                            If amount <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 130)))
                                CompanyAccountCode = "3100001"
                                descr = "IAD PHIL ER"
                        ...
                        Case 63
                            amount = Format(grd.get_TextMatrix(n, 124))
                            If amount <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 130)))
                                CompanyAccountCode = "3100001"
                                descr = "IAD PAG ER"
                            ...
                            End If
                        Case 64
                            amount = Format(grd.get_TextMatrix(n, 125))
                            If amount <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 128)))
                                CompanyAccountCode = "3100001"
                                acfc = 0
                                descr = "TECH SSS ER"
                            Else
                            ...
                            End If
                        Case 65
                            amount = Format(grd.get_TextMatrix(n, 126))
                            If amount <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 128)))
                                CompanyAccountCode = "3100001"
                                acfc = 0
                            ...
                            End If
                        Case 66
                            amount = Format(grd.get_TextMatrix(n, 127))
                            If amount <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 128)))
                                CompanyAccountCode = "3100001"
                                acfc = 0
                            ...
                            '\-----------------End of debit/
                        Case 67
                            acfc = Format(grd.get_TextMatrix(n, 129))
                            If acfc <> 0 Then
                                cccc = Trim(Format(grd.get_TextMatrix(n, 130)))
                                CompanyAccountCode = "3100001"
                                amount = 0
...
extcase:
                ...
                sqltxt = "Insert into basecorprt_corp(bcode,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "BAse Remittance" & " " & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
...
extcase:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "Remittance BB - Showroom")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim squery As String = "Select * from basecorprt_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'  "
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3100001, Credit - 3100001", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Remittance Base Branch"
    End Sub
End Class