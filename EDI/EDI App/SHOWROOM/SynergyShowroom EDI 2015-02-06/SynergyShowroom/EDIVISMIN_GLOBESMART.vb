Public Class EDIVISMIN_GLOBESMART
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        If cmbGS.Text = "" Then
            MsgBox("Fill first phone Company", 16, "Synergy EDI Showroom")
            Exit Sub
        End If
...
extcase:
                ...
                sqltxt = "Insert into globesmartbill_corp(bcode,companydesc,month_eli, year_eli, " & _
                         ...
                         "','" + cmbGS.Text + "','" & Format(g_month, "MM").ToString & "', '" & _
...
ext:
                If num1 = num2 Then
                    MsgBox("Dual Branch" & " " & num1 & " " & loc1 & " " & num2 & " " & loc2, 64, "Synergy EDI Vismin")
                    dualbranch = True
                End If
            Next
        Next
...
extcase:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5330003, Credit - 3100005", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
