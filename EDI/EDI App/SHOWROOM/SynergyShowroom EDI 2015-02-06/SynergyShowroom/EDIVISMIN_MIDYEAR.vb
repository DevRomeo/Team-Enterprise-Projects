Public Class EDIVISMIN_MIDYEAR
    ...
    Private Sub EDIVISMIN_MIDYEAR_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub

    Private Sub EDIVISMIN_MIDYEAR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "MidYear-" & gs_serverloc & " " & gs_version
        grp.Hide()
...
extcase:
                ...
                sqltxt = "Insert into midyear_corp(bcode,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Mid Year" & " " & "for" & " " & txtDesc.Text.Trim
...
alreadysaveext:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim squery As String = "Select * from MIDYEAR_corp where " & _
        "month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'  "
...
extcase:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 2010002, Credit - 3100001", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "MID Year"
