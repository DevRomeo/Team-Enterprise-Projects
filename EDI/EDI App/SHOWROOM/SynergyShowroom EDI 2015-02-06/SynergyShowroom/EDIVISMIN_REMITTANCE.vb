Public Class EDIVISMIN_REMITTANCE
    ...
    Private Sub EDIVISMIN_REMITTANCE_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub

    Private Sub EDIVISMIN_REMITTANCE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Remittance-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Remittance - Showroom")
            Exit Sub
        End If
                    ...
                    Select Case r
                        ...
                        Case 4
                            ...
                            If acfc <> 0 Then
                                ...
                                descr = "Remittance " & " " & Label7.Text
                                cccc = Format(grd.get_TextMatrix(n, 6))
                            Else
                                GoTo extcase
                            End If
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Remittance" & " " & cboSheet.Text.Trim & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5410001, Debit - 5420001 ,Debit - 5430001, Credit - 3100001", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Remittance"
