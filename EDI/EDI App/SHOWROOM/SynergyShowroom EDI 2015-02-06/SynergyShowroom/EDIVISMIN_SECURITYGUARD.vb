Public Class EDIVISMIN_SECURITYGUARD
    ...
    Private Sub EDIVISMIN_SECURITYGUARD_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_SECURITYGUARD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Security Guard-" & gs_serverloc & " " & gs_version
        grp.Hide()
    ...
    Private Sub cboSheet_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboSheet.SelectedIndexChanged
        ...
        txtDesc.Text = ""
        If Len(cboSheet.Text) = 6 Then
            txtDesc.Text = cboSheet.Text.Substring(0, 3) & " " & cboSheet.Text.Substring(3, 1) & "-" & cboSheet.Text.Substring(4, 2)
        Else
            txtDesc.Text = cboSheet.Text.Substring(0, 3) & " " & cboSheet.Text.Substring(3, 2) & "-" & cboSheet.Text.Substring(5, 2)
        End If
    End Sub
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Security Guard - Showroom")
            Exit Sub
        End If
...
continuesave:
        ...
        sqltxt = "select * from Sg_corp1 where bcode = 000 and date_time > '" & _
                    ...
                    Select Case r
                        ...
                        Case 3
                            ...
                            If acfc <> 0 Then
                                ...
                                cccc = Format(grd.get_TextMatrix(n, 5))
                            End If
                    End Select
                    ' MsgBox(totalAmount)
...
extcase:
                ...
                sqltxt = "Insert into sg_corp1(bcode,paydesc,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "SG" & " " & "for" & " " & txtDesc.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from sg_corp1 where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' and paydesc = '" + txtDesc.Text + "'"
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 5370001, Debit - 2070103, Credit - 3100001", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Security Guard"
    End Sub
End Class