Public Class EDIVISMIN_PROVISIONBASEBRANCH
    ...
    Private Sub EDIVISMIN_PROVISIONBASEBRANCH_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_PROVISIONBASEBRANCH_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Provision-" & gs_serverloc2 & " " & gs_version
        grp.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Provision BB - Showroom")
            Exit Sub
        End If
...
continuesave:
        ...
        sqltxt = "select * from baseprovision_corp where bcode = 000 and date_time > '" & _
                ...
                For r = 1 To 5
                    ...
                    Select Case r
                        Case 1
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                descr = "Prov" & " " & txtDesc.Text
                                cccc = Trim(Format(grd.get_TextMatrix(n, 7)))
                        ...
                        Case 5
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                descr = "Prov" & " " & lblMonth.Text.Substring(0, 3) & " " & cboYear.Text
...
extcase:
                ...
                sqltxt = "Insert into baseprovision_corp(bcode,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "BASE Provision" & " " & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
...
ext:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "Provision BB - Showroom")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim squery As String = "Select * from baseprovision_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'  "
...
ext:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Provision Base Branch"
    End Sub
End Class