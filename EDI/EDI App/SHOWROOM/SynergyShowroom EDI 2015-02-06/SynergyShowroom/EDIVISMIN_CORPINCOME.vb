Public Class EDIVISMIN_CORPINCOME
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "KP Corp Income - Showroom")
            Exit Sub
        End If
...
continuesave:
        ...
        sqltxt = "select * from CORPINCOME_CORP where bcode = 000 and date_time > '" & _
        ...
        For n = 0 To grd.Rows - 2
            If Not LCase(grd.get_TextMatrix(n, 0).ToString) = "totals" Then
                ...
                'If jpoy.Error_SetRdr(sqlmsg, rdr, errormsg) Then Exit Sub
                ...
                If rdr.Read Then
                    ...
                    'If jpoy.Error_SetRdr(sqltxt, rdr, errormsg) Then Exit Sub
                    If db.isConnected Then                          '--------------7142010-------------------'
                        db.CloseConnection()                        '--------------7142010-------------------'
                    End If                                          '--------------7142010-------------------'
                    If ls_connection Is Nothing Then
                    ...
                    For r = 1 To 248
                        ...
                        'If jpoy.Error_SetComm(sqltxt, False, sqlmsg) Then
                        '    f.Error_Log(f.ErrTxt(sqltxt, sqlmsg), g_errLog)
                        '    Exit Sub
                        'End If
extcase:
                    ...
                    If n = grd.Rows - 3 Then
                        ...
                        db.Execute_SQLQuery(sqltxt)                     '--------------7142010-------------------'
                        db.CloseConnection()                            '--------------7142010-------------------'
                        'If jpoy.Error_SetComm(sqltxt, settrue, sqlmsg) Then              'true = to write (dont erase)
                        '    f.Error_Log(f.ErrTxt(sqltxt, sqlmsg), g_errLog)
                        '    Exit Sub
                        'End If
                        '<--------New Eli Code
