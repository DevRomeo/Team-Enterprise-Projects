Public Class EDIVISMIN_RECURRING
    ...
    Private Sub cmbdescgl_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbdescgl.SelectedIndexChanged
        If cmbdescgl.Text = "Computer Recur" Then
            Me.txtCredit.Text = 1110023
            Me.txtDebit.Text = 5540004
        End If

        If cmbdescgl.Text = "FFE Recur" Then
            Me.txtCredit.Text = 1110022
            Me.txtDebit.Text = 5540003
        End If

        If cmbdescgl.Text = "Leasehold Recur" Then
            Me.txtCredit.Text = 1110003
            Me.txtDebit.Text = 5550001
        End If

        If cmbdescgl.Text = "Office Eqt Recur" Then
            Me.txtCredit.Text = 1110024
            Me.txtDebit.Text = 5540005
        End If
    End Sub

    Private Sub EDIVISMIN_RECURRING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Recurring-" & gs_serverloc & " " & gs_version
        grp.Hide()
        cmbSt.Text = "False"
        Call Me.Init_Combo()
        btnSave.Hide()
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        If Me.TEXTBOX1.Text = "" Then
            MsgBox("Browse File First", 16, "Synergy EDI Showroom")
            Exit Sub
        End If
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Recurring - Showroom")
            Exit Sub
        End If
        ...
        For n = Val(txtstart.Text) - 2 To 0 Step -1
            ...
            If Not Trim(dg.Item(n, 0).ToString) = "" Then
                ...
                Else
                    ...
                    If rdr.Read Then
                        MsgBox("Some datas have not included. Please Check Excel File", 64, "Synergy EDI Showroom")
...
continuesave:
        ...
        sqltxt = "select * from recurring_corp where bcode = 000 and date_time > '" & _
                ...
                For r = 1 To 20
                    ...
                    Select Case r
                        Case 1
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                'CompanyAccountCode = "5550004"
                                descr = Format(grd.get_TextMatrix(n, 12))
                            Else
                                GoTo extcase
                            End If
                        Case 2
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 13))
                            Else
                                GoTo extcase
                            End If
                        Case 3
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 14))
                            Else
                                GoTo extcase
                            End If
                        Case 4
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 15))
                            Else
                                GoTo extcase
                            End If
                        Case 5
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 16))
                            Else
                                GoTo extcase
                            End If
                        Case 6
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 17))
                            Else
                                GoTo extcase
                            End If
                        Case 7
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 18))
                            Else
                                GoTo extcase
                            End If
                        Case 8
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 19))
                            Else
                                GoTo extcase
                            End If
                        Case 9
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 20))
                            Else
                                GoTo extcase
                            End If
                        Case 10
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = txtDebit.Text
                                descr = Format(grd.get_TextMatrix(n, 21))
                            Else
                                GoTo extcase
                            End If
                        Case 11
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                'CompanyAccountCode = "1110023"
                                CompanyAccountCode = txtCredit.Text
                                descr = Format(grd.get_TextMatrix(n, 12))
                            Else
                                GoTo extcase
                            End If
...
extcase:
                ...
                sqltxt = "Insert into recurring_corp(bcode, month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Recurring" & " " & cmbdescgl.Text.Trim & " " & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from recurring_corp where month_eli = '" & cboperiod.Text & "' and year_eli = '" & cboyear.Text & "' and bcode = '" & g & "'"
    ...
    Private Function errorcostcenter() As Boolean
        Dim n As Integer = Nothing
        For n = 0 To grd.Rows - 2
            Dim g As String = grd.get_TextMatrix(n, 18)
            If Len(g) < 8 Then
                MsgBox(grd.get_TextMatrix(n, 0) & " " & grd.get_TextMatrix(n, 1) & " " & "Please fill correct cost center", 64, "Cost Center Error")
...
ext:
                If num1 = num2 Then
                    MsgBox("Dual Branch" & " " & num1 & " " & loc1 & " " & num2 & " " & loc2, 64, "Synergy EDI Showroom")
                    dualbranch = True
                End If
            Next
        Next
