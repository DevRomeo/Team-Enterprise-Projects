Public Class EDIVISMIN_PAYROLL
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        If cmbdesc.Text = "" Then
            MsgBox("Fill Payroll date description", 16, "Synergy EDI Showroom")
            Exit Sub
        End If
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Payroll - Showroom")
            Exit Sub
        End If
...
ext:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Or cmbdesc.Text = "" Then
...
extcase:
                ...
                sqltxt = "Insert into sp_corp(bcode,paydesc, month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Payroll" & " " & "for" & " " & txtDesc.Text
...
extcase:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim squery As String = "Select * from sp_corp where paydesc = '" & paydesc & "' and month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "'  "
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        ...
        vbCrLf & "Credit - 3100001", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    Public Sub DATEFUNC()
