Public Class EDIVISAYAS_ProtectPlus
    ...
    'Private Sub VIS_AIRPHIL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Air Phil - Showroom")
            Exit Sub
        End If
...
continuesave:
        ...
        sqltxt = "select * from airphil_corp where bcode = 000 and date_time > '" & _
        ...
        For n = 0 To grd.Rows - 2
            ...
            If rdr.Read Then            'rdr.close - x
                ...
                For r = 1 To 6
                    ...
                    Select Case r
                        Case 1
                            amount = Format(grd.get_TextMatrix(n, 2))
                            If amount <> 0 Then
                                acfc = 0
                            ...
                            End If
                        Case 2
                            amount = Format(grd.get_TextMatrix(n, 3))
                            If amount <> 0 Then
                                acfc = 0
                            ...
                            End If
                        Case 3
                            acfc = Format(grd.get_TextMatrix(n, 4))
                            If acfc <> 0 Then
                                amount = 0
                                CompanyAccountCode = "4600011"

                            Else
                                GoTo extcase
                            End If
                        Case 4
                            amount = Format(grd.get_TextMatrix(n, 5))
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5530001"
                            Else
                            ...
                            End If
                        Case 5
                            amount = Format(grd.get_TextMatrix(n, 6))
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "3100007"
                            Else
                            ...
                            End If
                        Case 6
                            acfc = Format(grd.get_TextMatrix(n, 7))
                            If acfc <> 0 Then
                                amount = 0
                                CompanyAccountCode = "4600010"
                            Else
                                GoTo extcase
                            End If
                    End Select
...
extcase:
                ...
                sqltxt = "Insert into airphil_corp(bcode,month_eli, year_eli, " & _
            ...
            Else
                ...
                sqltxt = "Insert into wu_unknownbc(bcode, dr1, dr2) values('" & _
                                 bcode & "'," & Format(CDbl(grd.get_TextMatrix(n, 2)), "##0.00") & ", " & _
                                  Format(CDbl(grd.get_TextMatrix(n, 2)), "##0.00") & ")"
                If ls_connection Is Nothing Then
                    c.INITIALIZE_INI()
                End If
                ...
                f.Error_Log(grd.get_TextMatrix(n, 2) & " - " & grd.get_TextMatrix(n, 2) & " - " & _
                            grd.get_TextMatrix(n, 2) & " - " & grd.get_TextMatrix(n, 2), g_errBC)
                errCtr += 1
                strBC = strBC + "." + bcode
            End If
extloop:
        ...
        Dim act As String = "EDI" & " " & "Protect Plus Insurance" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfully saved all branches.", MsgBoxStyle.Information, "EDI - Showroom")
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from airphil_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = " & g & " "
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3130127, Credit - 4510001", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Protect Plus Insurance"

    End Sub

    Private Sub EDIVISAYAS_ProtectPlus_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Protect Plus Insurance-" & gs_serverloc & " " & gs_version
        grp.Hide()
        txtDesc.Text = lblMonth.Text.Substring(0, 3) & " " & cboYear.Text
        cmbSt.Text = "False"
        Call Me.Init_Combo()
