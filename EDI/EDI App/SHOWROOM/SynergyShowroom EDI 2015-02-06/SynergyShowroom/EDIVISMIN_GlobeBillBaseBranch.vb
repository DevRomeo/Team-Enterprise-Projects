Public Class EDIVISMIN_GlobeBillBaseBranch
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If Me.TEXTBOX1.Text = "" Then
            MsgBox("Browse File First", 16, "Globe Bill -" & gs_serverloc2 & gs_version)
            Exit Sub
        End If
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Globe Bill -" & gs_serverloc2 & gs_version)
            Exit Sub
        End If
        ...
        For n = Val(txtstart.Text) - 2 To 0 Step -1
            ...
            If Not Trim(dg.Item(n, 0).ToString) = "" Then
                ...
                Else
                    ...
                    If rdr.Read Then
                        MsgBox("Some datas have not included. Please Check Excel File", 64, "Globe Bill -" & gs_serverloc2 & gs_version)
...
extcase:
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtDesc.Text = "" Then
            MsgBox("Please fill description text box", 16, "Globe -" & gs_serverloc2 & gs_version)
            Exit Sub
        End If
...
extalreadysave:
    ...
    Private Sub CheckBC_Errors()
        ...
        If errCtr <= 0 Then
            MsgBox("Successfuly saved all branches.", MsgBoxStyle.Information, "Globe Bill -" & gs_serverloc2 & gs_version)
        Else
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To grd.Rows - 2
            ...
            Dim s As String = "Select * from smart3_corp where month_eli = '" & cboPeriod.Text & "' and year_eli = '" & cboYear.Text & "' and bcode = '" & g & "' and companydesc = 'GLOBE'"
