Public Class VIS_FOREX
    ...
    Private Sub VIS_FOREX_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub VIS_FOREX_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Forex-" & gs_serverloc & " " & gs_version
        grp.Hide()
...
continuesave:
        ...
        sqltxt = "select * from FOREX_corp where bcode = 000 and date_time > '" & _
        ...
        For n = 0 To GRD.Rows - 2
            ...
            If rdr.Read Then            'rdr.close - x
                ...
                ctrFn = ctrFn + 1
                ''alter starts
                '/new ely code 8-13-2012
                Dim forex_gldeb As String = Nothing
                Dim forex_glcredit As String = Nothing
                Dim total As Double = Format(GRD.get_TextMatrix(n, 2))

                If total > 0 Then
                    forex_gldeb = "3100001"
                    forex_glcredit = "4500012"
                    total = Format(GRD.get_TextMatrix(n, 2))
                Else
                    forex_gldeb = "4500012"
                    forex_glcredit = "3100001"
                    total = Format(GRD.get_TextMatrix(n, 3))
                End If
                '\new ely code 8-13-2012
                For r = 1 To 2
                    ...
                    Select Case r
                        Case 1
                            amount = total 'new eli
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = forex_gldeb
                            Else
                                GoTo extcase
                            End If
                        Case 2
                            ...
                            If acfc <> 0 Then
                                amount = 0
                                CompanyAccountCode = forex_glcredit
...
extcase:
                ...
                sqltxt = "Insert into FOREX_corp(bcode,monthdesc,month_eli, year_eli, " & _
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "FOREX" & " " & "for" & " " & txtDesc.Text
...
extalreadysave:
    ...
    Private Function alreadysave() As Boolean
        ...
        For n = 0 To GRD.Rows - 2
            ...
            Dim s As String = "Select * from FOREX_corp where month_eli like '" & cboPeriod.Text & "' and year_eli like '" & cboYear.Text & "' and bcode like '" & g & "' and monthdesc like '" + lblMonth.Text + "'"
...
ext:
    ...
    Private Sub Label8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label8.Click
        MsgBox("Debit - 3131004, Credit - 4220054", 64, "Synergy EDI Showroom")
        Exit Sub
    End Sub
...
extcase:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "FOREX"
