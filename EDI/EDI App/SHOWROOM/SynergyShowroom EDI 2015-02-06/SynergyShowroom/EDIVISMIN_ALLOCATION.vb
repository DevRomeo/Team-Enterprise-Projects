Public Class EDIVISMIN_ALLOCATION
    ...
    Private Sub EDIVISMIN_ALLOCATION_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim main As New Main
        Me.Hide()
        main.Show()
    End Sub
    Private Sub EDIVISMIN_ALLOCATION_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        If txtStart.Text = "" Then
            MsgBox("START ROW NOT FILLED", 64, "Synergy EDI Showroom")
            Exit Sub
        End If
                ...
                For r = 1 To 47
                    ...
                    Select Case r
                        ...
                        Case 26
                            ...
                            End If
                        Case 27
                            amount = Format(grd.get_TextMatrix(n, 28))
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5540002"
                            Else
                        ...
                        Case 46
                            ...
                            If amount <> 0 Then
                                acfc = 0
                                CompanyAccountCode = "5240001"
                                'cccc = grd.get_TextMatrix(n, 43)
                            Else
                                GoTo extcase
                            End If
                        Case 47
                            acfc = Format(grd.get_TextMatrix(n, 48)) 'new eli
                            If acfc <> 0 Then
                                amount = 0
                                CompanyAccountCode = "3100001"
                                cccc = grd.get_TextMatrix(n, 49)
                            Else
                                GoTo extcase
                            End If
                    End Select
...
extloop:
        ...
        Dim act As String = "EDI" & " " & "Allocation" & " " & "for" & " " & lblMonth.Text.Trim & " " & cboYear.Text.Trim
...
extcase:
    ...
    Private Sub txtDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesc.TextChanged
        Label7.Text = txtDesc.Text & " " & "Allocation"
    End Sub
