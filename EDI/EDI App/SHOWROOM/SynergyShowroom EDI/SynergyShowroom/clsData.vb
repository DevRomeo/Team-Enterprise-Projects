Public Class clsData
    ...
    Dim server, ui, db, pass, ls_jobtitle, ls_jobtitle1, ls_jobtitle2 As String
    ...
    Public Function Error_Inititalize_INI() As Boolean
        Try
            Dim sr As New IO.StreamReader(Application.StartupPath & "\EDISHOWROOM.ini")
            ...
            While Not line Is Nothing
                ...
                If line.StartsWith("[job1]=") Then
                    ls_jobtitle = Replace(line, "[job1]=", "")
                    MODLS_JOBTITLE = ls_jobtitle
                End If
                line = sr.ReadLine
            End While
            sr.Close()
