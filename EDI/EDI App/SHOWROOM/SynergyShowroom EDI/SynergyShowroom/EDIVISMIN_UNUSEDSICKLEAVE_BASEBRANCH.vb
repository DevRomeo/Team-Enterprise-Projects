...
continuesave:
        ...
        sqltxt = "select * from BaseCorpUnusedSickLeave_corp where bcode = 000 and date_time > '" & _
...
extcase:
                ...
                sqltxt = "Insert into BaseCorpUnusedSickLeave_corp(bcode,paydesc, month_eli, year_eli, " & _
