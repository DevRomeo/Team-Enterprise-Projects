...
namespace AccountingWeb.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Authenticate(LoginModel signIn, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var srvcLoginR = srvc.Login(new LoginParameters() { username = signIn.Username, password = signIn.Password });
