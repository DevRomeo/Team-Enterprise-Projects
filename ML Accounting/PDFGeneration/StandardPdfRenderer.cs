...
namespace PDFGeneration
{
    public class StandardPdfRenderer
    {
        ...
        public byte[] Render(string htmlText, string pageTitle)
        {
            ...
            {
                using (var pdfDocument = new Document(PageSize.LETTER, HorizontalMargin, HorizontalMargin, VerticalMargin, VerticalMargin))
                {
        ...
        public byte[] PageSplit(string htmlText, string pageTitle)
        {
