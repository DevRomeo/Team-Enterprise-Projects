...
namespace ML.Web.Models
{
    public class UpdateEmployeeViewModel
    {
        ...
        [RegularExpression(@"^[a-zA-Z ]+$", ErrorMessage = "Last Name field accept only letters.")]
        [Display(Name = "Last Name")]        
        public string lastname { get; set; }

        [StringLength(50, ErrorMessage = "First Name must be a letters with a maximum length of 50.")]
        [RegularExpression(@"^[a-zA-Z ]+$", ErrorMessage = "First Name field accept only letters.")]
        [Display(Name = "First Name")]        
        public string firstname { get; set; }

        [StringLength(50, ErrorMessage = "Middle Name must be a letters with a maximum length of 50.")]
        [RegularExpression(@"^[a-zA-Z ]+$", ErrorMessage = "Middle Name field accept only letters.")]
        ...
        [RegularExpression(@"^[0-9a-zA-Z''-'\s.,]{1,40}$", ErrorMessage = "The field Address will not accept special characters.")]
        ...
        [RegularExpression(@"^(\(\d{3}\) |\d{3}-)\d{3}-\d{4}$", ErrorMessage = "The Phone No. field is not a valid format. (ex. (000) 000-0000 )")]
        [Display(Name = "Phone №")]
        ...
        [RegularExpression(@"^[a-zA-Z ]+$", ErrorMessage = "The Nationality field accept only letters")]        
        ...
        [Display(Name = "Gov't ID №")]
        [Required(ErrorMessage = "Gov't ID is required")]
